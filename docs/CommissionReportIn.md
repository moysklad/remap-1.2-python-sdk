...
**return_to_commissioner_positions** | [**CommissionReportInReturnedPositionList**](.md) | Метаданные позиций возврата на склад комиссионера Полученного отчета комиссионера | [optional] 
...
json = "{}"
# create an instance of CommissionReportIn from a JSON string
commission_report_in_instance = CommissionReportIn.from_json(json)
# print the JSON string representation of the object
print(CommissionReportIn.to_json())

# convert the object into a dict
commission_report_in_dict = commission_report_in_instance.to_dict()
# create an instance of CommissionReportIn from a dict
commission_report_in_from_dict = CommissionReportIn.from_dict(commission_report_in_dict)
```
