...
json = "{}"
# create an instance of RetailShiftOperationRetailDrawerCashOut from a JSON string
retail_shift_operation_retail_drawer_cash_out_instance = RetailShiftOperationRetailDrawerCashOut.from_json(json)
# print the JSON string representation of the object
print(RetailShiftOperationRetailDrawerCashOut.to_json())

# convert the object into a dict
retail_shift_operation_retail_drawer_cash_out_dict = retail_shift_operation_retail_drawer_cash_out_instance.to_dict()
# create an instance of RetailShiftOperationRetailDrawerCashOut from a dict
retail_shift_operation_retail_drawer_cash_out_from_dict = RetailShiftOperationRetailDrawerCashOut.from_dict(retail_shift_operation_retail_drawer_cash_out_dict)
```
