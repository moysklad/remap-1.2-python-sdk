...
**overhead** | **float** | Накладные расходы по позиции. Если позиции Приемки не заданы, накладные расходы на уровне документа задать нельзя.  | [optional] [readonly] 
...
json = "{}"
# create an instance of SupplyPosition from a JSON string
supply_position_instance = SupplyPosition.from_json(json)
# print the JSON string representation of the object
print(SupplyPosition.to_json())

# convert the object into a dict
supply_position_dict = supply_position_instance.to_dict()
# create an instance of SupplyPosition from a dict
supply_position_from_dict = SupplyPosition.from_dict(supply_position_dict)
```
