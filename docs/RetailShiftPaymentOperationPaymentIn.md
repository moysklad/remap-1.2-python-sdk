...
json = "{}"
# create an instance of RetailShiftPaymentOperationPaymentIn from a JSON string
retail_shift_payment_operation_payment_in_instance = RetailShiftPaymentOperationPaymentIn.from_json(json)
# print the JSON string representation of the object
print(RetailShiftPaymentOperationPaymentIn.to_json())

# convert the object into a dict
retail_shift_payment_operation_payment_in_dict = retail_shift_payment_operation_payment_in_instance.to_dict()
# create an instance of RetailShiftPaymentOperationPaymentIn from a dict
retail_shift_payment_operation_payment_in_from_dict = RetailShiftPaymentOperationPaymentIn.from_dict(retail_shift_payment_operation_payment_in_dict)
```
