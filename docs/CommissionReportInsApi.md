...
[**move_commission_report_in_to_trash**](CommissionReportInsApi.md#move_commission_report_in_to_trash) | **POST** /entity/commissionreportin/{id}/trash | Удалить CommissionReportIn в корзину
...
# **move_commission_report_in_to_trash**
> move_commission_report_in_to_trash(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Удалить CommissionReportIn в корзину
        api_instance.move_commission_report_in_to_trash(id, accept=accept, accept_encoding=accept_encoding)
    except Exception as e:
        print("Exception when calling CommissionReportInsApi->move_commission_report_in_to_trash: %s\n" % e)
```
