...
json = "{}"
# create an instance of FinanceInOperationRetailShift from a JSON string
finance_in_operation_retail_shift_instance = FinanceInOperationRetailShift.from_json(json)
# print the JSON string representation of the object
print(FinanceInOperationRetailShift.to_json())

# convert the object into a dict
finance_in_operation_retail_shift_dict = finance_in_operation_retail_shift_instance.to_dict()
# create an instance of FinanceInOperationRetailShift from a dict
finance_in_operation_retail_shift_from_dict = FinanceInOperationRetailShift.from_dict(finance_in_operation_retail_shift_dict)
```
