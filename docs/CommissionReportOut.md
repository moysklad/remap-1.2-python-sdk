...
**positions** | [**CommissionReportOutPositionList**](.md) | Метаданные позиций Выданного отчета комиссионера | [optional] 
...
json = "{}"
# create an instance of CommissionReportOut from a JSON string
commission_report_out_instance = CommissionReportOut.from_json(json)
# print the JSON string representation of the object
print(CommissionReportOut.to_json())

# convert the object into a dict
commission_report_out_dict = commission_report_out_instance.to_dict()
# create an instance of CommissionReportOut from a dict
commission_report_out_from_dict = CommissionReportOut.from_dict(commission_report_out_dict)
```
