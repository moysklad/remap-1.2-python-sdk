...
finance_out_operation_purchase_order_instance = FinanceOutOperationPurchaseOrder.from_json(json)
# print the JSON string representation of the object
print(FinanceOutOperationPurchaseOrder.to_json())

# convert the object into a dict
finance_out_operation_purchase_order_dict = finance_out_operation_purchase_order_instance.to_dict()
# create an instance of FinanceOutOperationPurchaseOrder from a dict
finance_out_operation_purchase_order_from_dict = FinanceOutOperationPurchaseOrder.from_dict(finance_out_operation_purchase_order_dict)
```
