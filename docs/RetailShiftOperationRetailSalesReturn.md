...
retail_shift_operation_retail_sales_return_instance = RetailShiftOperationRetailSalesReturn.from_json(json)
# print the JSON string representation of the object
print(RetailShiftOperationRetailSalesReturn.to_json())

# convert the object into a dict
retail_shift_operation_retail_sales_return_dict = retail_shift_operation_retail_sales_return_instance.to_dict()
# create an instance of RetailShiftOperationRetailSalesReturn from a dict
retail_shift_operation_retail_sales_return_from_dict = RetailShiftOperationRetailSalesReturn.from_dict(retail_shift_operation_retail_sales_return_dict)
```
