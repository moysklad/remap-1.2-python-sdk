...
json = "{}"
# create an instance of CreateSalesReturnPositions200ResponseInner from a JSON string
create_sales_return_positions200_response_inner_instance = CreateSalesReturnPositions200ResponseInner.from_json(json)
# print the JSON string representation of the object
print(CreateSalesReturnPositions200ResponseInner.to_json())

# convert the object into a dict
create_sales_return_positions200_response_inner_dict = create_sales_return_positions200_response_inner_instance.to_dict()
# create an instance of CreateSalesReturnPositions200ResponseInner from a dict
create_sales_return_positions200_response_inner_from_dict = CreateSalesReturnPositions200ResponseInner.from_dict(create_sales_return_positions200_response_inner_dict)
```
