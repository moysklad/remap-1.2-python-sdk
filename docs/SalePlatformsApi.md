# moysklad_remap_12_sdk.SalePlatformsApi

All URIs are relative to *https://api.moysklad.ru/api/remap/1.2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_sale_platform_by_id**](SalePlatformsApi.md#get_sale_platform_by_id) | **GET** /entity/saleplatform/{id} | Получить Площадку для продаж по ID
[**get_sale_platforms**](SalePlatformsApi.md#get_sale_platforms) | **GET** /entity/saleplatform | Получить список площадок для продаж


# **get_sale_platform_by_id**
> SalePlatform get_sale_platform_by_id(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = moysklad_remap_12_sdk.SalePlatformsApi(api_client)
    ...
    try:
        # Получить Площадку для продаж по ID
        api_response = api_instance.get_sale_platform_by_id(id, accept=accept, accept_encoding=accept_encoding)
        print("The response of SalePlatformsApi->get_sale_platform_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SalePlatformsApi->get_sale_platform_by_id: %s\n" % e)
```
...
# **get_sale_platforms**
> SalePlatformList get_sale_platforms(limit=limit, offset=offset, search=search, filter=filter, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Получить список площадок для продаж
        api_response = api_instance.get_sale_platforms(limit=limit, offset=offset, search=search, filter=filter, accept=accept, accept_encoding=accept_encoding)
        print("The response of SalePlatformsApi->get_sale_platforms:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SalePlatformsApi->get_sale_platforms: %s\n" % e)
```
...
[**SalePlatformList**](SalePlatformList.md)
