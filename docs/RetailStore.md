...
------------ | ------------- | ------------- | -------------
**id** | **str** | ID Точки продаж | [optional] [readonly] 
...
json = "{}"
# create an instance of RetailStore from a JSON string
retail_store_instance = RetailStore.from_json(json)
# print the JSON string representation of the object
print(RetailStore.to_json())

# convert the object into a dict
retail_store_dict = retail_store_instance.to_dict()
# create an instance of RetailStore from a dict
retail_store_from_dict = RetailStore.from_dict(retail_store_dict)
```
