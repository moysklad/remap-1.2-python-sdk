...
[**move_internal_order_to_trash**](InternalOrdersApi.md#move_internal_order_to_trash) | **POST** /entity/internalorder/{id}/trash | Удалить InternalOrder в корзину
...
# **move_internal_order_to_trash**
> move_internal_order_to_trash(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Удалить InternalOrder в корзину
        api_instance.move_internal_order_to_trash(id, accept=accept, accept_encoding=accept_encoding)
    except Exception as e:
        print("Exception when calling InternalOrdersApi->move_internal_order_to_trash: %s\n" % e)
```
