# moysklad_remap_12_sdk.ProductionTasksApi

All URIs are relative to *https://api.moysklad.ru/api/remap/1.2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_production_task_metadata_attribute**](ProductionTasksApi.md#create_production_task_metadata_attribute) | **POST** /entity/productiontask/metadata/attributes | Создать Доп. поле Производственных задач
[**get_production_task_metadata_attribute**](ProductionTasksApi.md#get_production_task_metadata_attribute) | **GET** /entity/productiontask/metadata/attributes | Доп. поля ProductionTask


# **create_production_task_metadata_attribute**
> AttributeMetaInfo create_production_task_metadata_attribute(attribute_meta_info, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = moysklad_remap_12_sdk.ProductionTasksApi(api_client)
    ...
    try:
        # Создать Доп. поле Производственных задач
        api_response = api_instance.create_production_task_metadata_attribute(attribute_meta_info, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
        print("The response of ProductionTasksApi->create_production_task_metadata_attribute:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductionTasksApi->create_production_task_metadata_attribute: %s\n" % e)
```
...
# **get_production_task_metadata_attribute**
> AttributeMetaInfoList get_production_task_metadata_attribute(offset=offset, limit=limit, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Доп. поля ProductionTask
        api_response = api_instance.get_production_task_metadata_attribute(offset=offset, limit=limit, accept=accept, accept_encoding=accept_encoding)
        print("The response of ProductionTasksApi->get_production_task_metadata_attribute:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductionTasksApi->get_production_task_metadata_attribute: %s\n" % e)
```
