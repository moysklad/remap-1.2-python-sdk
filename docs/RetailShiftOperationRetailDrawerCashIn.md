...
json = "{}"
# create an instance of RetailShiftOperationRetailDrawerCashIn from a JSON string
retail_shift_operation_retail_drawer_cash_in_instance = RetailShiftOperationRetailDrawerCashIn.from_json(json)
# print the JSON string representation of the object
print(RetailShiftOperationRetailDrawerCashIn.to_json())

# convert the object into a dict
retail_shift_operation_retail_drawer_cash_in_dict = retail_shift_operation_retail_drawer_cash_in_instance.to_dict()
# create an instance of RetailShiftOperationRetailDrawerCashIn from a dict
retail_shift_operation_retail_drawer_cash_in_from_dict = RetailShiftOperationRetailDrawerCashIn.from_dict(retail_shift_operation_retail_drawer_cash_in_dict)
```
