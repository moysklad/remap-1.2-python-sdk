# moysklad_remap_12_sdk.GroupsApi

All URIs are relative to *https://api.moysklad.ru/api/remap/1.2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_group**](GroupsApi.md#create_group) | **POST** /entity/group | Создать группу
[**delete_group**](GroupsApi.md#delete_group) | **DELETE** /entity/group/{id} | Удалить группу
[**get_group_by_id**](GroupsApi.md#get_group_by_id) | **GET** /entity/group/{id} | Получить группу по ID
[**get_groups**](GroupsApi.md#get_groups) | **GET** /entity/group | Получить список групп
[**update_group**](GroupsApi.md#update_group) | **PUT** /entity/group/{id} | Обновить группу


# **create_group**
> Group create_group(group, expand=expand, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = moysklad_remap_12_sdk.GroupsApi(api_client)
    group = {name=Новый отдел} # Group | 
    ...
    try:
        # Создать группу
        api_response = api_instance.create_group(group, expand=expand, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
...
# **delete_group**
> delete_group(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Удалить группу
        api_instance.delete_group(id, accept=accept, accept_encoding=accept_encoding)
    except Exception as e:
...
# **get_group_by_id**
> Group get_group_by_id(id, expand=expand, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Получить группу по ID
        api_response = api_instance.get_group_by_id(id, expand=expand, accept=accept, accept_encoding=accept_encoding)
...
# **get_groups**
> GroupList get_groups(limit=limit, offset=offset, search=search, filter=filter, expand=expand, order=order, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Получить список групп
        api_response = api_instance.get_groups(limit=limit, offset=offset, search=search, filter=filter, expand=expand, order=order, accept=accept, accept_encoding=accept_encoding)
...
# **update_group**
> Group update_group(id, group, expand=expand, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = moysklad_remap_12_sdk.GroupsApi(api_client)
    id = 'id_example' # str | ID сущности
    group = moysklad_remap_12_sdk.Group() # Group | 
    expand = 'expand_example' # str | Замена ссылок объектами с помощью expand (optional)
    accept = application/json;charset=utf-8 # str |  (optional) (default to application/json;charset=utf-8)
    accept_encoding = 'gzip, deflate, br' # str |  (optional) (default to 'gzip, deflate, br')
    content_type = application/json # str |  (optional) (default to application/json)
    ...
    try:
        # Обновить группу
        api_response = api_instance.update_group(id, group, expand=expand, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
