...
customer_order_instance = CustomerOrder.from_json(json)
# print the JSON string representation of the object
print(CustomerOrder.to_json())

# convert the object into a dict
customer_order_dict = customer_order_instance.to_dict()
# create an instance of CustomerOrder from a dict
customer_order_from_dict = CustomerOrder.from_dict(customer_order_dict)
```
