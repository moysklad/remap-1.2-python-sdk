# moysklad_remap_12_sdk.RegionsApi

All URIs are relative to *https://api.moysklad.ru/api/remap/1.2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_region_by_id**](RegionsApi.md#get_region_by_id) | **GET** /entity/region/{id} | Получить регион по ID
[**get_regions**](RegionsApi.md#get_regions) | **GET** /entity/region | Получить список регионов


# **get_region_by_id**
> Region get_region_by_id(id, expand=expand, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = moysklad_remap_12_sdk.RegionsApi(api_client)
    ...
    try:
        # Получить регион по ID
        api_response = api_instance.get_region_by_id(id, expand=expand, accept=accept, accept_encoding=accept_encoding)
        print("The response of RegionsApi->get_region_by_id:\n")
        pprint(api_response)
...
# **get_regions**
> RegionList get_regions(limit=limit, offset=offset, search=search, filter=filter, expand=expand, order=order, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Получить список регионов
        api_response = api_instance.get_regions(limit=limit, offset=offset, search=search, filter=filter, expand=expand, order=order, accept=accept, accept_encoding=accept_encoding)
