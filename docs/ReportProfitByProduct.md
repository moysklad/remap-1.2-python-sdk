...
```python
from moysklad_remap_12_sdk.models.report_profit_by_product import ReportProfitByProduct

# TODO update the JSON string below
json = "{}"
# create an instance of ReportProfitByProduct from a JSON string
report_profit_by_product_instance = ReportProfitByProduct.from_json(json)
# print the JSON string representation of the object
print(ReportProfitByProduct.to_json())

# convert the object into a dict
report_profit_by_product_dict = report_profit_by_product_instance.to_dict()
# create an instance of ReportProfitByProduct from a dict
report_profit_by_product_from_dict = ReportProfitByProduct.from_dict(report_profit_by_product_dict)
```
