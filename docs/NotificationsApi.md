# moysklad_remap_12_sdk.NotificationsApi

All URIs are relative to *https://api.moysklad.ru/api/remap/1.2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_notification_settings**](NotificationsApi.md#get_notification_settings) | **GET** /notification/settings | Получить настройки уведомлений
[**update_notification_settings**](NotificationsApi.md#update_notification_settings) | **PUT** /notification/settings | Изменить настройки уведомлений


# **get_notification_settings**
> NotificationSettings get_notification_settings(accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = moysklad_remap_12_sdk.NotificationsApi(api_client)
    ...
    try:
        # Получить настройки уведомлений
        api_response = api_instance.get_notification_settings(accept=accept, accept_encoding=accept_encoding)
...
> NotificationSettings update_notification_settings(notification_settings, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = moysklad_remap_12_sdk.NotificationsApi(api_client)
    notification_settings = moysklad_remap_12_sdk.NotificationSettings() # NotificationSettings | 
    accept = application/json;charset=utf-8 # str |  (optional) (default to application/json;charset=utf-8)
    accept_encoding = 'gzip, deflate, br' # str |  (optional) (default to 'gzip, deflate, br')
    ...
    try:
        # Изменить настройки уведомлений
        api_response = api_instance.update_notification_settings(notification_settings, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
        print("The response of NotificationsApi->update_notification_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NotificationsApi->update_notification_settings: %s\n" % e)
```
