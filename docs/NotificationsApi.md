...
------------- | ------------- | -------------
[**delete_notification**](NotificationsApi.md#delete_notification) | **DELETE** /notification/{id} | Удалить уведомление
[**get_notification_by_id**](NotificationsApi.md#get_notification_by_id) | **GET** /notification/{id} | Получить уведомление
...
[**get_notifications**](NotificationsApi.md#get_notifications) | **GET** /notification | Получить ленту уведомлений
[**mark_all_notifications_as_read**](NotificationsApi.md#mark_all_notifications_as_read) | **PUT** /notification/markasreadall | Отметить все уведомления как прочитанные
[**mark_notification_as_read**](NotificationsApi.md#mark_notification_as_read) | **PUT** /notification/{id}/markasread | Отметить уведомление как прочитанное
...
# **delete_notification**
> delete_notification(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Удалить уведомление
        api_instance.delete_notification(id, accept=accept, accept_encoding=accept_encoding)
...
> NotificationAbstract get_notification_by_id(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Получить уведомление
        api_response = api_instance.get_notification_by_id(id, accept=accept, accept_encoding=accept_encoding)
...
# **get_notifications**
> NotificationList get_notifications(limit=limit, offset=offset, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Получить ленту уведомлений
        api_response = api_instance.get_notifications(limit=limit, offset=offset, accept=accept, accept_encoding=accept_encoding)
...
> mark_all_notifications_as_read(accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Отметить все уведомления как прочитанные
        api_instance.mark_all_notifications_as_read(accept=accept, accept_encoding=accept_encoding)
    except Exception as e:
...
> mark_notification_as_read(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Отметить уведомление как прочитанное
        api_instance.mark_notification_as_read(id, accept=accept, accept_encoding=accept_encoding)
    except Exception as e:
