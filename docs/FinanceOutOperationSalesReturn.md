...
json = "{}"
# create an instance of FinanceOutOperationSalesReturn from a JSON string
finance_out_operation_sales_return_instance = FinanceOutOperationSalesReturn.from_json(json)
# print the JSON string representation of the object
print(FinanceOutOperationSalesReturn.to_json())

# convert the object into a dict
finance_out_operation_sales_return_dict = finance_out_operation_sales_return_instance.to_dict()
# create an instance of FinanceOutOperationSalesReturn from a dict
finance_out_operation_sales_return_from_dict = FinanceOutOperationSalesReturn.from_dict(finance_out_operation_sales_return_dict)
```
