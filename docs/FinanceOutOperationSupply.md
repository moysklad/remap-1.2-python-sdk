...
json = "{}"
# create an instance of FinanceOutOperationSupply from a JSON string
finance_out_operation_supply_instance = FinanceOutOperationSupply.from_json(json)
# print the JSON string representation of the object
print(FinanceOutOperationSupply.to_json())

# convert the object into a dict
finance_out_operation_supply_dict = finance_out_operation_supply_instance.to_dict()
# create an instance of FinanceOutOperationSupply from a dict
finance_out_operation_supply_from_dict = FinanceOutOperationSupply.from_dict(finance_out_operation_supply_dict)
```
