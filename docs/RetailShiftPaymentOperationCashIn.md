...
json = "{}"
# create an instance of RetailShiftPaymentOperationCashIn from a JSON string
retail_shift_payment_operation_cash_in_instance = RetailShiftPaymentOperationCashIn.from_json(json)
# print the JSON string representation of the object
print(RetailShiftPaymentOperationCashIn.to_json())

# convert the object into a dict
retail_shift_payment_operation_cash_in_dict = retail_shift_payment_operation_cash_in_instance.to_dict()
# create an instance of RetailShiftPaymentOperationCashIn from a dict
retail_shift_payment_operation_cash_in_from_dict = RetailShiftPaymentOperationCashIn.from_dict(retail_shift_payment_operation_cash_in_dict)
```
