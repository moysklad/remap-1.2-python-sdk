...
json = "{}"
# create an instance of FinanceOutOperationInvoiceIn from a JSON string
finance_out_operation_invoice_in_instance = FinanceOutOperationInvoiceIn.from_json(json)
# print the JSON string representation of the object
print(FinanceOutOperationInvoiceIn.to_json())

# convert the object into a dict
finance_out_operation_invoice_in_dict = finance_out_operation_invoice_in_instance.to_dict()
# create an instance of FinanceOutOperationInvoiceIn from a dict
finance_out_operation_invoice_in_from_dict = FinanceOutOperationInvoiceIn.from_dict(finance_out_operation_invoice_in_dict)
```
