...
loss_position_instance = LossPosition.from_json(json)
# print the JSON string representation of the object
print(LossPosition.to_json())

# convert the object into a dict
loss_position_dict = loss_position_instance.to_dict()
# create an instance of LossPosition from a dict
loss_position_from_dict = LossPosition.from_dict(loss_position_dict)
```
