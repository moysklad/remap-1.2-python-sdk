...
json = "{}"
# create an instance of FinanceInOperationPurchaseReturn from a JSON string
finance_in_operation_purchase_return_instance = FinanceInOperationPurchaseReturn.from_json(json)
# print the JSON string representation of the object
print(FinanceInOperationPurchaseReturn.to_json())

# convert the object into a dict
finance_in_operation_purchase_return_dict = finance_in_operation_purchase_return_instance.to_dict()
# create an instance of FinanceInOperationPurchaseReturn from a dict
finance_in_operation_purchase_return_from_dict = FinanceInOperationPurchaseReturn.from_dict(finance_in_operation_purchase_return_dict)
```
