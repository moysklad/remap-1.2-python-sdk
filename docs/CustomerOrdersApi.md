...
[**create_customer_order_notes_batch**](CustomerOrdersApi.md#create_customer_order_notes_batch) | **POST** /entity/customerorder/{id}/notes/batch | Массовое создание и обновление Событий Заказа покупателя
...
[**delete_customer_order_notes_batch**](CustomerOrdersApi.md#delete_customer_order_notes_batch) | **POST** /entity/customerorder/{id}/notes/delete | Массовое удаление Событий Заказа покупателя
...
[**move_customer_order_to_trash**](CustomerOrdersApi.md#move_customer_order_to_trash) | **POST** /entity/customerorder/{id}/trash | Удалить CustomerOrders в корзину
...
# **create_customer_order_notes_batch**
> List[EventNote] create_customer_order_notes_batch(id, event_note, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Массовое создание и обновление Событий Заказа покупателя
        api_response = api_instance.create_customer_order_notes_batch(id, event_note, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
        print("The response of CustomerOrdersApi->create_customer_order_notes_batch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomerOrdersApi->create_customer_order_notes_batch: %s\n" % e)
```
...
# **delete_customer_order_notes_batch**
> delete_customer_order_notes_batch(id, event_note, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Массовое удаление Событий Заказа покупателя
        api_instance.delete_customer_order_notes_batch(id, event_note, accept=accept, accept_encoding=accept_encoding, content_type=content_type)
    except Exception as e:
        print("Exception when calling CustomerOrdersApi->delete_customer_order_notes_batch: %s\n" % e)
```
...
> AuditEventList get_customer_order_audit_events(id, limit=limit, offset=offset, accept=accept, accept_encoding=accept_encoding)
...
# **move_customer_order_to_trash**
> move_customer_order_to_trash(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Удалить CustomerOrders в корзину
        api_instance.move_customer_order_to_trash(id, accept=accept, accept_encoding=accept_encoding)
    except Exception as e:
        print("Exception when calling CustomerOrdersApi->move_customer_order_to_trash: %s\n" % e)
```
