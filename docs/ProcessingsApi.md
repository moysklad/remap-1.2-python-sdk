...
[**move_processing_to_trash**](ProcessingsApi.md#move_processing_to_trash) | **POST** /entity/processing/{id}/trash | Удалить Processing в корзину
...
# **move_processing_to_trash**
> move_processing_to_trash(id, accept=accept, accept_encoding=accept_encoding)
...
with moysklad_remap_12_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Удалить Processing в корзину
        api_instance.move_processing_to_trash(id, accept=accept, accept_encoding=accept_encoding)
    except Exception as e:
        print("Exception when calling ProcessingsApi->move_processing_to_trash: %s\n" % e)
```
