...
conf = moysklad_remap_12_sdk.Configuration(
    username='the-user',
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.moysklad.ru/api/remap/1.2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("moysklad_remap_12_sdk")
