...
class ExpenseItemsApi:
    ...
    def create_expense_item(
        ...
        :param expense_item: (required)
        :type expense_item: ExpenseItem
        ...
        _param = self._create_expense_item_serialize(
    ...
    @validate_call
    def create_expense_item_with_http_info(
        self,
        expense_item: ExpenseItem,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_expense_item_without_preload_content(
        self,
        expense_item: ExpenseItem,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_expense_item_serialize(
        self,
        expense_item,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/expenseitem',
    ...
    @validate_call
    def create_expense_items_batch(
        self,
        expense_item: Annotated[List[ExpenseItem], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
        ...
        :param expense_item: (required)
        :type expense_item: List[ExpenseItem]
        :param expand: Замена ссылок объектами с помощью expand
        :type expand: str
        :param accept:
        :type accept: str
        ...
        _param = self._create_expense_items_batch_serialize(
            expense_item=expense_item,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def create_expense_items_batch_with_http_info(
        self,
        expense_item: Annotated[List[ExpenseItem], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_expense_items_batch_without_preload_content(
        self,
        expense_item: Annotated[List[ExpenseItem], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_expense_items_batch_serialize(
        self,
        expense_item,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/expenseitem/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_expense_item(
        ...
        _param = self._delete_expense_item_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_expense_item_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_expense_item_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_expense_item_serialize(
        self,
        id,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/expenseitem/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_expense_items_batch(
        self,
        expense_item: Annotated[List[ExpenseItem], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        ...
        _param = self._delete_expense_items_batch_serialize(
            expense_item=expense_item,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_expense_items_batch_with_http_info(
        self,
        expense_item: Annotated[List[ExpenseItem], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_expense_items_batch_without_preload_content(
        self,
        expense_item: Annotated[List[ExpenseItem], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_expense_items_batch_serialize(
        self,
        expense_item,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/expenseitem/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_expense_item_by_id(
        ...
        _param = self._get_expense_item_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_expense_item_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_expense_item_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_expense_item_by_id_serialize(
        self,
        id,
        expand,
        accept,
    ...
    def get_expense_items(
        ...
        _param = self._get_expense_items_serialize(
            limit=limit,
            offset=offset,
            search=search,
            filter=filter,
    ...
    @validate_call
    def get_expense_items_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    @validate_call
    def get_expense_items_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    def _get_expense_items_serialize(
        self,
        limit,
        offset,
        search,
    ...
    def update_expense_item(
        ...
        _param = self._update_expense_item_serialize(
            id=id,
            expense_item=expense_item,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def update_expense_item_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expense_item: ExpenseItem,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    @validate_call
    def update_expense_item_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expense_item: ExpenseItem,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    def _update_expense_item_serialize(
        self,
        id,
        expense_item,
        expand,
