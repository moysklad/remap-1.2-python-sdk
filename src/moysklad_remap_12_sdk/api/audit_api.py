...
class AuditApi:
    ...
    def get_entity_audit_events(
        ...
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Максимальное количество событий аудита в выданном списке (максимум 100)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        :type id: str
        :param limit: Максимальное количество событий аудита в выданном списке (максимум 100)
        :type limit: int
        :param offset: Отступ в выданном списке
        :type offset: int
        :param accept:
        ...
        _param = self._get_entity_audit_events_serialize(
            type=type,
            id=id,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_entity_audit_events_with_http_info(
        self,
        type: Annotated[StrictStr, Field(description="Тип сущности в URL, например `product` или `customerorder`")],
        id: Annotated[StrictStr, Field(description="ID сущности")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Максимальное количество событий аудита в выданном списке (максимум 100)")] = None,
    ...
    @validate_call
    def get_entity_audit_events_without_preload_content(
        self,
        type: Annotated[StrictStr, Field(description="Тип сущности в URL, например `product` или `customerorder`")],
        id: Annotated[StrictStr, Field(description="ID сущности")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Максимальное количество событий аудита в выданном списке (максимум 100)")] = None,
    ...
    def _get_entity_audit_events_serialize(
        self,
        type,
        id,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/entity/{type}/{id}/audit',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
