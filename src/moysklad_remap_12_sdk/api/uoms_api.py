...
class UomsApi:
    ...
    def create_uom(
        ...
        _param = self._create_uom_serialize(
            uom=uom,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def create_uom_without_preload_content(
        self,
        uom: Uom,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_uoms_batch(
        self,
        uom: Annotated[List[Uom], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
        ...
        _param = self._create_uoms_batch_serialize(
            uom=uom,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def create_uoms_batch_with_http_info(
        self,
        uom: Annotated[List[Uom], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_uoms_batch_without_preload_content(
        self,
        uom: Annotated[List[Uom], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_uoms_batch_serialize(
        self,
        uom,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/uom/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_uom(
        ...
        _param = self._delete_uom_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_uom_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def delete_uoms_batch(
        ...
        _param = self._delete_uoms_batch_serialize(
            uom=uom,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_uoms_batch_with_http_info(
        self,
        uom: Annotated[List[Uom], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_uoms_batch_without_preload_content(
        self,
        uom: Annotated[List[Uom], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_uoms_batch_serialize(
        self,
        uom,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/uom/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_uom_by_id(
        ...
        _param = self._get_uom_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_uom_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_uom_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def get_uoms(
        ...
        _param = self._get_uoms_serialize(
            limit=limit,
            offset=offset,
            search=search,
            filter=filter,
    ...
    @validate_call
    def get_uoms_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    def update_uom(
        ...
        _param = self._update_uom_serialize(
            id=id,
            uom=uom,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def update_uom_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        uom: Uom,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
