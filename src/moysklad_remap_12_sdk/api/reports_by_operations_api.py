...
class ReportsByOperationsApi:
    ...
    @validate_call
    def get_by_operations_in_transit(
        self,
        filter: Annotated[StrictStr, Field(description="Фильтрация выборки. Обязательно указать `assortment=<href>` — ссылку на товар, модификацию или партию. Можно фильтровать только по одной номенклатуре. ")],
        ...
        _param = self._get_by_operations_in_transit_serialize(
            filter=filter,
            limit=limit,
            offset=offset,
            accept=accept,
    ...
    @validate_call
    def get_by_operations_in_transit_with_http_info(
        self,
        filter: Annotated[StrictStr, Field(description="Фильтрация выборки. Обязательно указать `assortment=<href>` — ссылку на товар, модификацию или партию. Можно фильтровать только по одной номенклатуре. ")],
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ByOperationsInTransitList]:
        """Получить Отчет по документам, отображающий ожидание
    ...
    @validate_call
    def get_by_operations_in_transit_without_preload_content(
        self,
        filter: Annotated[StrictStr, Field(description="Фильтрация выборки. Обязательно указать `assortment=<href>` — ссылку на товар, модификацию или партию. Можно фильтровать только по одной номенклатуре. ")],
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    def _get_by_operations_in_transit_serialize(
        self,
        filter,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/report/byoperations/intransit',
    ...
    def get_by_operations_reserve(
        ...
        _param = self._get_by_operations_reserve_serialize(
            filter=filter,
            limit=limit,
            offset=offset,
            accept=accept,
    ...
    @validate_call
    def get_by_operations_reserve_with_http_info(
        self,
        filter: Annotated[StrictStr, Field(description="Фильтрация выборки. Обязательно указать `assortment=<href>` — ссылку на товар, модификацию или партию. Можно фильтровать только по одной номенклатуре. ")],
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ByOperationsReserveList]:
        """Получить Отчет по документам, отображающий резервы
    ...
    @validate_call
    def get_by_operations_reserve_without_preload_content(
        self,
        filter: Annotated[StrictStr, Field(description="Фильтрация выборки. Обязательно указать `assortment=<href>` — ссылку на товар, модификацию или партию. Можно фильтровать только по одной номенклатуре. ")],
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    def _get_by_operations_reserve_serialize(
        self,
        filter,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/report/byoperations/reserve',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_by_operations_stock(
        ...
        _param = self._get_by_operations_stock_serialize(
            filter=filter,
            limit=limit,
            offset=offset,
            accept=accept,
    ...
    @validate_call
    def get_by_operations_stock_with_http_info(
        self,
        filter: Annotated[StrictStr, Field(description="Фильтрация выборки. Обязательно указать `assortment=<href>` — ссылку на товар, модификацию или партию. Можно фильтровать только по одной номенклатуре. ")],
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ByOperationsStockList]:
        """Получить Отчет по документам, отображающий остатки
    ...
    @validate_call
    def get_by_operations_stock_without_preload_content(
        self,
        filter: Annotated[StrictStr, Field(description="Фильтрация выборки. Обязательно указать `assortment=<href>` — ссылку на товар, модификацию или партию. Можно фильтровать только по одной номенклатуре. ")],
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    def _get_by_operations_stock_serialize(
        self,
        filter,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/report/byoperations/stock',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
