...
class CompanySettingsApi:
    ...
    def _get_company_settings_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/context/companysettings',
    ...
    @validate_call
    def get_company_settings_metadata(
        self,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _param = self._get_company_settings_metadata_serialize(
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_company_settings_metadata_with_http_info(
        self,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CompanySettingsMetadata]:
        """Получить метаданные настроек компании
    ...
    @validate_call
    def get_company_settings_metadata_without_preload_content(
        self,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _get_company_settings_metadata_serialize(
        self,
        accept,
        accept_encoding,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/context/companysettings/metadata',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_company_settings(
        ...
        :param company_settings: (required)
        :type company_settings: CompanySettings
        :param accept:
        :type accept: str
        :param accept_encoding:
        :type accept_encoding: str
        ...
        _param = self._update_company_settings_serialize(
    ...
    @validate_call
    def update_company_settings_with_http_info(
        self,
        company_settings: CompanySettings,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def update_company_settings_without_preload_content(
        self,
        company_settings: CompanySettings,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _update_company_settings_serialize(
        self,
        company_settings,
        accept,
        accept_encoding,
