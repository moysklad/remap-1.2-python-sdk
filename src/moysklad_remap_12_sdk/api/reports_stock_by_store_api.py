...
class ReportsStockByStoreApi:
    ...
    def get_stock_by_store(
        ...
        _param = self._get_stock_by_store_serialize(
            limit=limit,
            offset=offset,
            filter=filter,
            order=order,
    ...
    @validate_call
    def get_stock_by_store_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Фильтрация выборки")] = None,
    ...
    @validate_call
    def get_stock_by_store_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Фильтрация выборки")] = None,
    ...
    def _get_stock_by_store_serialize(
        self,
        limit,
        offset,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/report/stock/bystore',
