...
class CashiersApi:
    ...
    def get_cashier_by_id(
        ...
        _param = self._get_cashier_by_id_serialize(
    ...
    @validate_call
    def get_cashier_by_id_with_http_info(
        self,
        retail_store_id: StrictStr,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    @validate_call
    def get_cashier_by_id_without_preload_content(
        self,
        retail_store_id: StrictStr,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    def _get_cashier_by_id_serialize(
        self,
        retail_store_id,
        id,
        expand,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/entity/retailstore/{retailStoreId}/cashiers/{id}',
    ...
    def get_cashiers(
        ...
        _param = self._get_cashiers_serialize(
            retail_store_id=retail_store_id,
            limit=limit,
            offset=offset,
            search=search,
    ...
    @validate_call
    def get_cashiers_with_http_info(
        self,
        retail_store_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    @validate_call
    def get_cashiers_without_preload_content(
        self,
        retail_store_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    def _get_cashiers_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/entity/retailstore/{retailStoreId}/cashiers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
