...
class WebhookStocksApi:
    ...
    @validate_call
    def create_or_update_webhook_stocks_batch(
        self,
        webhook_stock: Annotated[List[WebhookStock], Field(min_length=1, max_length=1000)],
        ...
        :param webhook_stock: (required)
        :type webhook_stock: List[WebhookStock]
        ...
        _param = self._create_or_update_webhook_stocks_batch_serialize(
            webhook_stock=webhook_stock,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def create_or_update_webhook_stocks_batch_with_http_info(
        self,
        webhook_stock: Annotated[List[WebhookStock], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_or_update_webhook_stocks_batch_without_preload_content(
        self,
        webhook_stock: Annotated[List[WebhookStock], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_or_update_webhook_stocks_batch_serialize(
        self,
        webhook_stock,
        expand,
        accept,
        ...
        if webhook_stock is not None:
            _body_params = webhook_stock
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/webhookstock/batch',
    ...
    @validate_call
    def create_webhook_stock(
        self,
        webhook_stock: WebhookStock,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
        ...
        :param webhook_stock: (required)
        :type webhook_stock: WebhookStock
        :param expand: Замена ссылок объектами с помощью expand
        :type expand: str
        :param accept:
        :type accept: str
        ...
        _param = self._create_webhook_stock_serialize(
            webhook_stock=webhook_stock,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def create_webhook_stock_with_http_info(
        self,
        webhook_stock: WebhookStock,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_webhook_stock_without_preload_content(
        self,
        webhook_stock: WebhookStock,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_webhook_stock_serialize(
        self,
        webhook_stock,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/webhookstock',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_webhook_stock(
        ...
        _param = self._delete_webhook_stock_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_webhook_stock_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_webhook_stock_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_webhook_stock_serialize(
        self,
        id,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/webhookstock/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_webhook_stocks_batch(
        self,
        webhook_stock: Annotated[List[WebhookStock], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        ...
        _param = self._delete_webhook_stocks_batch_serialize(
            webhook_stock=webhook_stock,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_webhook_stocks_batch_with_http_info(
        self,
        webhook_stock: Annotated[List[WebhookStock], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_webhook_stocks_batch_without_preload_content(
        self,
        webhook_stock: Annotated[List[WebhookStock], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_webhook_stocks_batch_serialize(
        self,
        webhook_stock,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/webhookstock/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_webhook_stock_by_id(
        ...
        _param = self._get_webhook_stock_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_webhook_stock_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_webhook_stock_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_webhook_stock_by_id_serialize(
        self,
        id,
        expand,
        accept,
    ...
    def get_webhook_stocks(
        ...
        _param = self._get_webhook_stocks_serialize(
            limit=limit,
            offset=offset,
            search=search,
            filter=filter,
    ...
    @validate_call
    def get_webhook_stocks_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    @validate_call
    def get_webhook_stocks_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    def _get_webhook_stocks_serialize(
        self,
        limit,
        offset,
        search,
    ...
    def update_webhook_stock(
        ...
        _param = self._update_webhook_stock_serialize(
            id=id,
            webhook_stock=webhook_stock,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def update_webhook_stock_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        webhook_stock: WebhookStock,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    @validate_call
    def update_webhook_stock_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        webhook_stock: WebhookStock,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    def _update_webhook_stock_serialize(
        self,
        id,
        webhook_stock,
        expand,
