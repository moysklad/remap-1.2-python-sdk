...
class PriceTypesApi:
    ...
    @validate_call
    def create_price_types_batch(
        self,
        price_type: Annotated[List[PriceType], Field(min_length=1)],
        ...
        :param price_type: (required)
        :type price_type: List[PriceType]
        :param accept:
        :type accept: str
        ...
        _param = self._create_price_types_batch_serialize(
    ...
    @validate_call
    def create_price_types_batch_with_http_info(
        self,
        price_type: Annotated[List[PriceType], Field(min_length=1)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_price_types_batch_without_preload_content(
        self,
        price_type: Annotated[List[PriceType], Field(min_length=1)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _create_price_types_batch_serialize(
        self,
        price_type,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/context/companysettings/pricetype',
    ...
    def get_default_price_type(
        ...
        _param = self._get_default_price_type_serialize(
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_default_price_type_with_http_info(
        self,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_default_price_type_without_preload_content(
        self,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _get_default_price_type_serialize(
        self,
        accept,
        accept_encoding,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/context/companysettings/pricetype/default',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_price_type_by_id(
        ...
        _param = self._get_price_type_by_id_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_price_type_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_price_type_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _get_price_type_by_id_serialize(
        self,
        id,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/context/companysettings/pricetype/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_price_types(
        ...
        _param = self._get_price_types_serialize(
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_price_types_with_http_info(
        self,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_price_types_without_preload_content(
        self,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _get_price_types_serialize(
        self,
        accept,
        accept_encoding,
        _request_auth,
