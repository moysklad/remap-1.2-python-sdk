...
class ProductFoldersApi:
    ...
    def create_product_folder(
        ...
        :param product_folder: (required)
        :type product_folder: ProductFolder
        ...
        _param = self._create_product_folder_serialize(
    ...
    @validate_call
    def create_product_folder_with_http_info(
        self,
        product_folder: ProductFolder,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_product_folder_without_preload_content(
        self,
        product_folder: ProductFolder,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_product_folder_serialize(
        self,
        product_folder,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/productfolder',
    ...
    @validate_call
    def create_product_folders_batch(
        self,
        product_folder: Annotated[List[ProductFolder], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
        ...
        :param product_folder: (required)
        :type product_folder: List[ProductFolder]
        :param expand: Замена ссылок объектами с помощью expand
        :type expand: str
        :param accept:
        :type accept: str
        ...
        _param = self._create_product_folders_batch_serialize(
            product_folder=product_folder,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def create_product_folders_batch_with_http_info(
        self,
        product_folder: Annotated[List[ProductFolder], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_product_folders_batch_without_preload_content(
        self,
        product_folder: Annotated[List[ProductFolder], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_product_folders_batch_serialize(
        self,
        product_folder,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/productfolder/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_product_folder(
        ...
        _param = self._delete_product_folder_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_product_folder_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_product_folder_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_product_folder_serialize(
        self,
        id,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/productfolder/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_product_folders_batch(
        self,
        product_folder: Annotated[List[ProductFolder], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        ...
        _param = self._delete_product_folders_batch_serialize(
            product_folder=product_folder,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_product_folders_batch_with_http_info(
        self,
        product_folder: Annotated[List[ProductFolder], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_product_folders_batch_without_preload_content(
        self,
        product_folder: Annotated[List[ProductFolder], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_product_folders_batch_serialize(
        self,
        product_folder,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/productfolder/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_product_folder_by_id(
        ...
        _param = self._get_product_folder_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_product_folder_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_product_folder_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_product_folder_by_id_serialize(
        self,
        id,
        expand,
        accept,
    ...
    def get_product_folders(
        ...
        _param = self._get_product_folders_serialize(
            limit=limit,
            offset=offset,
            search=search,
            filter=filter,
    ...
    @validate_call
    def get_product_folders_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    @validate_call
    def get_product_folders_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    def _get_product_folders_serialize(
        self,
        limit,
        offset,
        search,
    ...
    def update_product_folder(
        ...
        _param = self._update_product_folder_serialize(
            id=id,
            product_folder=product_folder,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def update_product_folder_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        product_folder: ProductFolder,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    @validate_call
    def update_product_folder_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        product_folder: ProductFolder,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    def _update_product_folder_serialize(
        self,
        id,
        product_folder,
        expand,
