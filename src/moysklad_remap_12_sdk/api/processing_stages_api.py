...
class ProcessingStagesApi:
    ...
    def create_processing_stage(
        ...
        :param processing_stage: (required)
        :type processing_stage: ProcessingStage
        ...
        _param = self._create_processing_stage_serialize(
    ...
    @validate_call
    def create_processing_stage_with_http_info(
        self,
        processing_stage: ProcessingStage,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_processing_stage_without_preload_content(
        self,
        processing_stage: ProcessingStage,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_processing_stage_serialize(
        self,
        processing_stage,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/processingstage',
    ...
    @validate_call
    def create_processing_stages_batch(
        self,
        processing_stage: Annotated[List[ProcessingStage], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
        ...
        :param processing_stage: (required)
        :type processing_stage: List[ProcessingStage]
        :param expand: Замена ссылок объектами с помощью expand
        :type expand: str
        :param accept:
        :type accept: str
        ...
        _param = self._create_processing_stages_batch_serialize(
            processing_stage=processing_stage,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def create_processing_stages_batch_with_http_info(
        self,
        processing_stage: Annotated[List[ProcessingStage], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_processing_stages_batch_without_preload_content(
        self,
        processing_stage: Annotated[List[ProcessingStage], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_processing_stages_batch_serialize(
        self,
        processing_stage,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/processingstage/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_processing_stage(
        ...
        _param = self._delete_processing_stage_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_processing_stage_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_processing_stage_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_processing_stage_serialize(
        self,
        id,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/processingstage/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_processing_stages_batch(
        self,
        processing_stage: Annotated[List[ProcessingStage], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        ...
        _param = self._delete_processing_stages_batch_serialize(
            processing_stage=processing_stage,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_processing_stages_batch_with_http_info(
        self,
        processing_stage: Annotated[List[ProcessingStage], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_processing_stages_batch_without_preload_content(
        self,
        processing_stage: Annotated[List[ProcessingStage], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_processing_stages_batch_serialize(
        self,
        processing_stage,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/processingstage/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_processing_stage_by_id(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        ...
        _param = self._get_processing_stage_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_processing_stage_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_processing_stage_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_processing_stage_by_id_serialize(
        self,
        id,
        expand,
        accept,
    ...
    def get_processing_stages(
        ...
        _param = self._get_processing_stages_serialize(
            limit=limit,
            offset=offset,
            filter=filter,
            expand=expand,
    ...
    @validate_call
    def get_processing_stages_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Фильтрация выборки")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProcessingStageList]:
        """Получить список Этапов производства
    ...
    @validate_call
    def get_processing_stages_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Фильтрация выборки")] = None,
    ...
    def _get_processing_stages_serialize(
        self,
        limit,
        offset,
        filter,
    ...
    def update_processing_stage(
        ...
        _param = self._update_processing_stage_serialize(
            id=id,
            processing_stage=processing_stage,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def update_processing_stage_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        processing_stage: ProcessingStage,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    @validate_call
    def update_processing_stage_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        processing_stage: ProcessingStage,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    def _update_processing_stage_serialize(
        self,
        id,
        processing_stage,
        expand,
