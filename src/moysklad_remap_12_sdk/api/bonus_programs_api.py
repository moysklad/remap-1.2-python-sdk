...
class BonusProgramsApi:
    ...
    def create_bonus_program(
        ...
        :param bonus_program: (required)
        :type bonus_program: BonusProgram
        ...
        _param = self._create_bonus_program_serialize(
    ...
    @validate_call
    def create_bonus_program_with_http_info(
        self,
        bonus_program: BonusProgram,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_bonus_program_without_preload_content(
        self,
        bonus_program: BonusProgram,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_bonus_program_serialize(
        self,
        bonus_program,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/bonusprogram',
    ...
    def delete_bonus_program(
        ...
        _param = self._delete_bonus_program_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_bonus_program_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_bonus_program_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_bonus_program_serialize(
        self,
        id,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/bonusprogram/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_bonus_programs_batch(
        self,
        bonus_program: Annotated[List[BonusProgram], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        :param bonus_program: (required)
        :type bonus_program: List[BonusProgram]
        :param accept:
        :type accept: str
        :param accept_encoding:
        :type accept_encoding: str
        ...
        _param = self._delete_bonus_programs_batch_serialize(
            bonus_program=bonus_program,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_bonus_programs_batch_with_http_info(
        self,
        bonus_program: Annotated[List[BonusProgram], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_bonus_programs_batch_without_preload_content(
        self,
        bonus_program: Annotated[List[BonusProgram], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_bonus_programs_batch_serialize(
        self,
        bonus_program,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/bonusprogram/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_bonus_program_by_id(
        ...
        _param = self._get_bonus_program_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_bonus_program_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_bonus_program_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_bonus_program_by_id_serialize(
        self,
        id,
        expand,
        accept,
    ...
    def get_bonus_programs(
        ...
        _param = self._get_bonus_programs_serialize(
            limit=limit,
            offset=offset,
            search=search,
            filter=filter,
    ...
    @validate_call
    def get_bonus_programs_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    @validate_call
    def get_bonus_programs_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    def _get_bonus_programs_serialize(
        self,
        limit,
        offset,
        search,
    ...
    def update_bonus_program(
        ...
        _param = self._update_bonus_program_serialize(
            id=id,
            bonus_program=bonus_program,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def update_bonus_program_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        bonus_program: BonusProgram,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    @validate_call
    def update_bonus_program_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        bonus_program: BonusProgram,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    def _update_bonus_program_serialize(
        self,
        id,
        bonus_program,
        expand,
