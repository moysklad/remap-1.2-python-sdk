...
class WebhooksApi:
    ...
    @validate_call
    def create_or_update_webhooks_batch(
        self,
        webhook: Annotated[List[Webhook], Field(min_length=1, max_length=1000)],
        ...
        _param = self._create_or_update_webhooks_batch_serialize(
            webhook=webhook,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def create_or_update_webhooks_batch_with_http_info(
        self,
        webhook: Annotated[List[Webhook], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_or_update_webhooks_batch_without_preload_content(
        self,
        webhook: Annotated[List[Webhook], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_or_update_webhooks_batch_serialize(
        self,
        webhook,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/webhook/batch',
    ...
    def _delete_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/webhook/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_webhooks_batch(
        ...
        _param = self._delete_webhooks_batch_serialize(
            webhook=webhook,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_webhooks_batch_with_http_info(
        self,
        webhook: Annotated[List[Webhook], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_webhooks_batch_without_preload_content(
        self,
        webhook: Annotated[List[Webhook], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_webhooks_batch_serialize(
        self,
        webhook,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/webhook/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
