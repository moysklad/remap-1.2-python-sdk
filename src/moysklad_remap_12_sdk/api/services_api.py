...
class ServicesApi:
    ...
    def add_service_files(
        ...
        _param = self._add_service_files_serialize(
            id=id,
    ...
    @validate_call
    def add_service_files_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        file_upload: Annotated[List[FileUpload], Field(max_length=10)],
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def add_service_files_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        file_upload: Annotated[List[FileUpload], Field(max_length=10)],
        accept: Optional[StrictStr] = None,
    ...
    def _add_service_files_serialize(
        self,
        id,
        file_upload,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/service/{id}/files',
    ...
    def create_services_batch(
        self,
        service: Annotated[List[Service], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
        ...
        _param = self._create_services_batch_serialize(
            service=service,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def create_services_batch_with_http_info(
        self,
        service: Annotated[List[Service], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_services_batch_without_preload_content(
        self,
        service: Annotated[List[Service], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_services_batch_serialize(
        self,
        service,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/service/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_service_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/service/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_service_file(
        ...
        _param = self._delete_service_file_serialize(
            id=id,
            file_id=file_id,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def delete_service_file_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        file_id: Annotated[StrictStr, Field(description="ID файла")],
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_service_file_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        file_id: Annotated[StrictStr, Field(description="ID файла")],
        accept: Optional[StrictStr] = None,
    ...
    def _delete_service_file_serialize(
        self,
        id,
        file_id,
        accept,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/service/{id}/files/{fileId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_services_batch(
        ...
        _param = self._delete_services_batch_serialize(
            service=service,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_services_batch_with_http_info(
        self,
        service: Annotated[List[Service], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_services_batch_without_preload_content(
        self,
        service: Annotated[List[Service], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_services_batch_serialize(
        self,
        service,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/service/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_service_by_id(
        ...
        _param = self._get_service_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_service_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_service_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_service_by_id_serialize(
        self,
        id,
        expand,
        accept,
    ...
    def get_service_files(
        ...
        _param = self._get_service_files_serialize(
            id=id,
            limit=limit,
            offset=offset,
            accept=accept,
    ...
    @validate_call
    def get_service_files_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    @validate_call
    def get_service_files_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    def _get_service_files_serialize(
        self,
        id,
        limit,
        offset,
