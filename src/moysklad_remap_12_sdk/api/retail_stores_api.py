...
class RetailStoresApi:
    ...
    @validate_call
    def add_master_retail_store(
        self,
        retail_store_id: StrictStr,
        ...
        :param retail_store_id: (required)
        :type retail_store_id: str
        ...
        _param = self._add_master_retail_store_serialize(
    ...
    @validate_call
    def add_master_retail_store_with_http_info(
        self,
        retail_store_id: StrictStr,
        retail_store: RetailStore,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def add_master_retail_store_without_preload_content(
        self,
        retail_store_id: StrictStr,
        retail_store: RetailStore,
        accept: Optional[StrictStr] = None,
    ...
    def _add_master_retail_store_serialize(
        self,
        retail_store_id,
        retail_store,
        accept,
        ...
        if retail_store_id is not None:
            _path_params['retailStoreId'] = retail_store_id
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/retailstore/{retailStoreId}/masterRetailStores',
    ...
    def _create_retail_store_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/retailstore',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _create_retail_stores_batch_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/retailstore/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_retail_store(
        ...
        _param = self._delete_retail_store_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_retail_store_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_retail_store_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_retail_store_serialize(
        self,
        id,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/retailstore/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_retail_stores_batch(
        self,
        ...
        _param = self._delete_retail_stores_batch_serialize(
            retail_store=retail_store,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_retail_stores_batch_with_http_info(
        self,
        retail_store: Annotated[List[RetailStore], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_retail_stores_batch_without_preload_content(
        self,
        retail_store: Annotated[List[RetailStore], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_retail_stores_batch_serialize(
        self,
        retail_store,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/retailstore/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_master_retail_stores(
        ...
        _param = self._get_master_retail_stores_serialize(
            retail_store_id=retail_store_id,
            limit=limit,
            offset=offset,
            search=search,
    ...
    @validate_call
    def get_master_retail_stores_with_http_info(
        self,
        retail_store_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    @validate_call
    def get_master_retail_stores_without_preload_content(
        self,
        retail_store_id: StrictStr,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
    ...
    def _get_master_retail_stores_serialize(
        self,
        retail_store_id,
        limit,
        offset,
    ...
    def get_retail_store_by_id(
        ...
        _param = self._get_retail_store_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_retail_store_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_retail_store_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_retail_store_by_id_serialize(
        self,
        id,
        expand,
        accept,
    ...
    def get_retail_stores(
        ...
        _param = self._get_retail_stores_serialize(
            limit=limit,
            offset=offset,
            search=search,
            filter=filter,
    ...
    @validate_call
    def get_retail_stores_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    @validate_call
    def get_retail_stores_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    def _get_retail_stores_serialize(
        self,
        limit,
        offset,
        search,
