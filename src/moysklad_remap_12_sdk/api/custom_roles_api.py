...
class CustomRolesApi:
    ...
    def create_custom_role(
        ...
        :param custom_role: (required)
        :type custom_role: CustomRole
        :param accept:
        :type accept: str
        ...
        _param = self._create_custom_role_serialize(
    ...
    @validate_call
    def create_custom_role_with_http_info(
        self,
        custom_role: CustomRole,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_custom_role_without_preload_content(
        self,
        custom_role: CustomRole,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _create_custom_role_serialize(
        self,
        custom_role,
        accept,
        accept_encoding,
    ...
    def delete_custom_role(
        ...
        _param = self._delete_custom_role_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_custom_role_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_custom_role_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_custom_role_serialize(
        self,
        id,
        accept,
        accept_encoding,
    ...
    def get_custom_role_by_id(
        ...
        _param = self._get_custom_role_by_id_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_custom_role_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_custom_role_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _get_custom_role_by_id_serialize(
        self,
        id,
        accept,
        accept_encoding,
    ...
    def get_custom_roles(
        ...
        _param = self._get_custom_roles_serialize(
            limit=limit,
            offset=offset,
            search=search,
            filter=filter,
    ...
    @validate_call
    def get_custom_roles_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    @validate_call
    def get_custom_roles_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    def _get_custom_roles_serialize(
        self,
        limit,
        offset,
        search,
    ...
    def update_custom_role(
        ...
        _param = self._update_custom_role_serialize(
            id=id,
            custom_role=custom_role,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def update_custom_role_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        custom_role: CustomRole,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def update_custom_role_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        custom_role: CustomRole,
        accept: Optional[StrictStr] = None,
    ...
    def _update_custom_role_serialize(
        self,
        id,
        custom_role,
        accept,
