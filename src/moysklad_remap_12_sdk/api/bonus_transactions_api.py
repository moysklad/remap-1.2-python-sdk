...
class BonusTransactionsApi:
    ...
    def create_bonus_transaction(
        ...
        :param bonus_transaction: (required)
        :type bonus_transaction: BonusTransaction
        ...
        _param = self._create_bonus_transaction_serialize(
    ...
    @validate_call
    def create_bonus_transaction_with_http_info(
        self,
        bonus_transaction: BonusTransaction,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_bonus_transaction_without_preload_content(
        self,
        bonus_transaction: BonusTransaction,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_bonus_transaction_serialize(
        self,
        bonus_transaction,
        expand,
        accept,
        ...
        if bonus_transaction is not None:
            _body_params = bonus_transaction
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/bonustransaction',
    ...
    @validate_call
    def create_bonus_transactions_batch(
        self,
        bonus_transaction: Annotated[List[BonusTransaction], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
        ...
        :param bonus_transaction: (required)
        :type bonus_transaction: List[BonusTransaction]
        :param expand: Замена ссылок объектами с помощью expand
        :type expand: str
        :param accept:
        :type accept: str
        ...
        _param = self._create_bonus_transactions_batch_serialize(
            bonus_transaction=bonus_transaction,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def create_bonus_transactions_batch_with_http_info(
        self,
        bonus_transaction: Annotated[List[BonusTransaction], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_bonus_transactions_batch_without_preload_content(
        self,
        bonus_transaction: Annotated[List[BonusTransaction], Field(min_length=1, max_length=1000)],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _create_bonus_transactions_batch_serialize(
        self,
        bonus_transaction,
        expand,
        accept,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/bonustransaction/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_bonus_transaction(
        ...
        _param = self._delete_bonus_transaction_serialize(
            id=id,
            accept=accept,
            accept_encoding=accept_encoding,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_bonus_transaction_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_bonus_transaction_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_bonus_transaction_serialize(
        self,
        id,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/entity/bonustransaction/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_bonus_transactions_batch(
        self,
        bonus_transaction: Annotated[List[BonusTransaction], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
        ...
        _param = self._delete_bonus_transactions_batch_serialize(
            bonus_transaction=bonus_transaction,
            accept=accept,
            accept_encoding=accept_encoding,
            content_type=content_type,
    ...
    @validate_call
    def delete_bonus_transactions_batch_with_http_info(
        self,
        bonus_transaction: Annotated[List[BonusTransaction], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_bonus_transactions_batch_without_preload_content(
        self,
        bonus_transaction: Annotated[List[BonusTransaction], Field(min_length=1, max_length=1000)],
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _delete_bonus_transactions_batch_serialize(
        self,
        bonus_transaction,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/bonustransaction/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_bonus_transaction_by_id(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
        ...
        _param = self._get_bonus_transaction_by_id_serialize(
            id=id,
            expand=expand,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_bonus_transaction_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_bonus_transaction_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_bonus_transaction_by_id_serialize(
        self,
        id,
        expand,
        accept,
    ...
    def get_bonus_transactions(
        ...
        _param = self._get_bonus_transactions_serialize(
            limit=limit,
            offset=offset,
            search=search,
            filter=filter,
    ...
    @validate_call
    def get_bonus_transactions_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    @validate_call
    def get_bonus_transactions_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Контекстный поиск по строковым полям сущностей")] = None,
    ...
    def _get_bonus_transactions_serialize(
        self,
        limit,
        offset,
        search,
    ...
    def update_bonus_transaction(
        ...
        _param = self._update_bonus_transaction_serialize(
            id=id,
            bonus_transaction=bonus_transaction,
            expand=expand,
            accept=accept,
    ...
    @validate_call
    def update_bonus_transaction_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        bonus_transaction: BonusTransaction,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    @validate_call
    def update_bonus_transaction_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID сущности")],
        bonus_transaction: BonusTransaction,
        expand: Annotated[Optional[StrictStr], Field(description="Замена ссылок объектами с помощью expand")] = None,
    ...
    def _update_bonus_transaction_serialize(
        self,
        id,
        bonus_transaction,
        expand,
