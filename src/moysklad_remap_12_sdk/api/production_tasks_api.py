...
class ProductionTasksApi:
    ...
    @validate_call
    def create_production_task_metadata_attribute(
        self,
        ...
        _param = self._create_production_task_metadata_attribute_serialize(
    ...
    @validate_call
    def create_production_task_metadata_attribute_with_http_info(
        self,
        attribute_meta_info: AttributeMetaInfo,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    @validate_call
    def create_production_task_metadata_attribute_without_preload_content(
        self,
        attribute_meta_info: AttributeMetaInfo,
        accept: Optional[StrictStr] = None,
        accept_encoding: Optional[StrictStr] = None,
    ...
    def _create_production_task_metadata_attribute_serialize(
        self,
        attribute_meta_info,
        accept,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/entity/productiontask/metadata/attributes',
    ...
    @validate_call
    def get_production_task_metadata_attribute(
        self,
        ...
        _param = self._get_production_task_metadata_attribute_serialize(
            offset=offset,
            limit=limit,
            accept=accept,
            accept_encoding=accept_encoding,
    ...
    @validate_call
    def get_production_task_metadata_attribute_with_http_info(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_production_task_metadata_attribute_without_preload_content(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Отступ в выданном списке")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Максимальное количество элементов в выданном списке (максимум 1000)")] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _get_production_task_metadata_attribute_serialize(
        self,
        offset,
        limit,
        accept,
