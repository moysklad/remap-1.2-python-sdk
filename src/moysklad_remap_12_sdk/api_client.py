...
from moysklad_remap_12_sdk.api_response import ApiResponse, T as ApiResponseT
import moysklad_remap_12_sdk.models
from moysklad_remap_12_sdk import rest
from moysklad_remap_12_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(moysklad_remap_12_sdk.models, klass)
