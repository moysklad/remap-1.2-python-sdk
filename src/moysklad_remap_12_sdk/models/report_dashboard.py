...
class ReportDashboard(BaseModel):
    ...
    """ # noqa: E501
    sales: Optional[ReportDashboardPeriodMetrics] = None
    orders: Optional[ReportDashboardPeriodMetrics] = None
    money: Optional[ReportDashboardMoney] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sales", "orders", "money"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "sales": ReportDashboardPeriodMetrics.from_dict(obj["sales"]) if obj.get("sales") is not None else None,
            "orders": ReportDashboardPeriodMetrics.from_dict(obj["orders"]) if obj.get("orders") is not None else None,
            "money": ReportDashboardMoney.from_dict(obj["money"]) if obj.get("money") is not None else None
        })
