...
class PayrollPositionList(BaseModel):
    """
    Список позиций Начисления зарплаты
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = Field(default=None, description="Метаданные о выдаче")
    rows: Optional[List[PayrollPosition]] = Field(default=None, description="Массив позиций Начисления зарплаты")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [PayrollPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
