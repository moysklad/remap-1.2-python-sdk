...
class PriceType(EntityWithMeta):
    """
    Тип цены
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID типа цены")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование типа цены")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код типа цены", alias="externalCode")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "name", "externalCode"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/context" + "/companysettings" + "/pricetype" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
