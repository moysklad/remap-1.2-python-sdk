...
from pydantic import ConfigDict, StrictFloat, StrictInt, StrictStr, field_validator
...
class AttributeDouble(AttributeAbstract):
    """
    AttributeDouble
    """ # noqa: E501
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['double']):
            raise ValueError("must be one of enum values ('double')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeDouble from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeDouble from a dict"""
        if obj is None:
            return None
