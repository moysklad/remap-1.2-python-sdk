...
class CommissionReportInPositionList(BaseModel):
    """
    Список позиций Полученного отчета комиссионера
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[CommissionReportInPosition]] = Field(default=None, description="Массив позиций Полученного отчета комиссионера")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CommissionReportInPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
