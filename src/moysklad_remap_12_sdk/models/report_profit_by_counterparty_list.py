...
class ReportProfitByCounterpartyList(BaseModel):
    """
    Отчет «Прибыльность по покупателям»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportProfitByCounterparty]] = Field(default=None, description="Массив строк отчета прибыльности по покупателям")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportProfitByCounterparty.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
