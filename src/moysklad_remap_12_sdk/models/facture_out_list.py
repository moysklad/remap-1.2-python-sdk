...
class FactureOutList(BaseModel):
    """
    Список Счетов-фактур выданных
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[FactureOut]] = Field(default=None, description="Массив Счетов-фактур выданных")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [FactureOut.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
