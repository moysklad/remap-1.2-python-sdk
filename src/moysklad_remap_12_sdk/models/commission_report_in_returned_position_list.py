...
class CommissionReportInReturnedPositionList(BaseModel):
    """
    Список позиций возврата на склад комиссионера Полученного отчета комиссионера
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[CommissionReportInReturnedPosition]] = Field(default=None, description="Массив позиций возврата на склад комиссионера Полученного отчета комиссионера")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CommissionReportInReturnedPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
