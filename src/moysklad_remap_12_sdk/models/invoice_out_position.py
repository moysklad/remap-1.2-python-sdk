...
class InvoiceOutPosition(EntityWithMeta):
    """
    ...
    quantity: Optional[Union[Annotated[float, Field(strict=True, gt=0)], Annotated[int, Field(strict=True, gt=0)]]] = Field(default=None, description="Количество товаров/услуг данного вида в позиции")
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "quantity", "price", "discount", "vat", "vatEnabled", "assortment", "pack"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/invoiceout" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
