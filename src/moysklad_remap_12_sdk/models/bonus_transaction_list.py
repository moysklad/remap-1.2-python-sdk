...
class BonusTransactionList(BaseModel):
    """
    Список бонусных операций
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[BonusTransaction]] = Field(default=None, description="Массив бонусных операций")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [BonusTransaction.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
