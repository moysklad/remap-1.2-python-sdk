...
class PriceList(EntityWithMeta):
    """
    Прайс-лист
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID Прайс-листа")
    ...
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код Прайс-листа")
    columns: Optional[List[PriceListColumn]] = Field(default=None, description="Массив столбцов описания таблицы")
    created: Optional[StrictStr] = Field(default=None, description="Дата создания")
    deleted: Optional[StrictStr] = Field(default=None, description="Момент последнего удаления Прайс-листа")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Комментарий Прайс-листа")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Прайс-листа", alias="externalCode")
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Прайс-листа")
    organization: Optional[Organization] = None
    owner: Optional[Employee] = Field(default=None, description="Владелец (Сотрудник)")
    positions: Optional[PriceListPositionList] = Field(default=None, description="Метаданные позиций Прайс-листа")
    price_type: Optional[PriceType] = Field(default=None, description="Объект типа цены", alias="priceType")
    ...
    state: Optional[State] = Field(default=None, description="Метаданные статуса Прайс-листа")
    ...
    updated: Optional[StrictStr] = Field(default=None, description="Момент последнего обновления Прайс-листа")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "applicable", "attributes", "code", "columns", "created", "deleted", "description", "externalCode", "files", "group", "moment", "name", "organization", "owner", "positions", "priceType", "printed", "published", "shared", "state", "syncId", "updated"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/pricelist" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "code": obj.get("code"),
            "columns": [PriceListColumn.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
            ...
            "positions": PriceListPositionList.from_dict(obj["positions"]) if obj.get("positions") is not None else None,
