...
class Image(BaseModel):
    ...
    title: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Название изображения")
    filename: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Имя файла")
    content: Optional[StrictStr] = Field(default=None, description="Изображение, закодированное в Base64")
    ...
    __properties: ClassVar[List[str]] = ["meta", "title", "filename", "content", "size", "updated", "tiny", "miniature"]
