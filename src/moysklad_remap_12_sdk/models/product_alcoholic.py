...
class ProductAlcoholic(BaseModel):
    """
    Объект, содержащий поля алкогольной продукции
    """ # noqa: E501
    excise: Optional[StrictBool] = Field(default=None, description="Содержит акцизную марку")
    type: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Код вида продукции")
    strength: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Крепость")
    volume: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Объём тары")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["excise", "type", "strength", "volume"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.excise is None and "excise" in self.model_fields_set:
            _dict['excise'] = None
