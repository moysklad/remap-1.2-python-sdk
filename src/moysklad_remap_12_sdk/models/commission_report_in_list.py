...
class CommissionReportInList(BaseModel):
    """
    Список Полученных отчетов комиссионера
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[CommissionReportIn]] = Field(default=None, description="Массив Полученных отчетов комиссионера")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CommissionReportIn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
