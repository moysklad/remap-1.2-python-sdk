...
class MinimumStockWarehouseVaried(MinimumStockAbstract):
    """
    MinimumStockWarehouseVaried
    """ # noqa: E501
    type: StrictStr
    store_balances: Optional[StoreBalanceList] = Field(default=None, description="""Неснижаемые остатки по складам""", alias="storeBalances")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['WAREHOUSE_VARIED']):
            raise ValueError("must be one of enum values ('WAREHOUSE_VARIED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "type": obj.get("type") if obj.get("type") is not None else 'WAREHOUSE_VARIED',
