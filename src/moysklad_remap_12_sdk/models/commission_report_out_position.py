...
class CommissionReportOutPosition(EntityWithMeta):
    """
    ...
    quantity: Optional[Union[Annotated[float, Field(strict=True, gt=0)], Annotated[int, Field(strict=True, gt=0)]]] = Field(default=None, description="Количество товаров/услуг в позиции")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Цена товара в копейках")
    reward: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Вознаграждение")
    vat: Optional[StrictInt] = Field(default=None, description="НДС для позиции")
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "quantity", "price", "reward", "vat", "vatEnabled", "assortment", "pack"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/commissionreportout" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
