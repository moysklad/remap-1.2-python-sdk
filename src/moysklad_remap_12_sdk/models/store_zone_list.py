...
class StoreZoneList(BaseModel):
    """
    Список зон Склада
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[StoreZone]] = Field(default=None, description="Массив зон Склада")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [StoreZone.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
...
StoreZoneList.model_rebuild(raise_errors=False)
