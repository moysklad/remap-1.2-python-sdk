...
class RetailDemandList(BaseModel):
    """
    Список Розничных продаж
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[RetailDemand]] = Field(default=None, description="Массив Розничных продаж")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [RetailDemand.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
