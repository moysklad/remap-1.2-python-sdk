...
class EnterList(BaseModel):
    """
    Список Оприходований
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[Enter]] = Field(default=None, description="Массив Оприходований")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Enter.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
