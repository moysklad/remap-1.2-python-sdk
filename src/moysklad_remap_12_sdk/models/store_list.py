...
class StoreList(BaseModel):
    ...
    rows: Optional[List[Store]] = Field(default=None, description="Массив Складов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Store.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
