...
class CounterpartyMetadata(BaseModel):
    """
    Метаданные контрагентов
    """ # noqa: E501
    meta: Optional[Meta] = None
    attributes: Optional[AttributeMetaInfoList] = None
    states: Optional[List[State]] = Field(default=None, description="Массив статусов контрагентов")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Тэги контрагентов")
    create_shared: Optional[StrictBool] = Field(default=None, description="Создавать новых контрагентов с меткой \"Общий\"", alias="createShared")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "attributes", "states", "tags", "createShared"]
