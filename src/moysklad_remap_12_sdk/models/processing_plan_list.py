...
class ProcessingPlanList(BaseModel):
    """
    Список Техкарт
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingPlan]] = Field(default=None, description="Массив Техкарт")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingPlan.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
