...
class MinimumStockAllWarehouseSame(MinimumStockAbstract):
    """
    MinimumStockAllWarehouseSame
    """ # noqa: E501
    type: StrictStr
    quantity: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Количество неснижаемого остатка")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ALL_WAREHOUSE_SAME']):
            raise ValueError("must be one of enum values ('ALL_WAREHOUSE_SAME')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "type": obj.get("type") if obj.get("type") is not None else 'ALL_WAREHOUSE_SAME',
