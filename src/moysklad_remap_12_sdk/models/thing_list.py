...
class ThingList(BaseModel):
    ...
    rows: Optional[List[Thing]] = Field(default=None, description="Массив Серийных номеров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Thing.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
