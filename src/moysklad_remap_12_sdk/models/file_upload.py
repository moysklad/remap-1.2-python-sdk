...
class FileUpload(BaseModel):
    ...
    """ # noqa: E501
    filename: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Имя файла с расширением")
    content: StrictStr = Field(description="Файл, закодированный в формате Base64")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["filename", "content"]
