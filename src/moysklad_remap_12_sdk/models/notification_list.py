...
class NotificationList(BaseModel):
    ...
    rows: Optional[List[NotificationAbstract]] = Field(default=None, description="Массив уведомлений разных типов, определяемых по meta.type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [NotificationAbstract.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
