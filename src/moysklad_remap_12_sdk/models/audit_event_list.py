...
class AuditEventList(BaseModel):
    ...
    rows: Optional[List[AuditEvent]] = Field(default=None, description="Массив событий аудита")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [AuditEvent.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
