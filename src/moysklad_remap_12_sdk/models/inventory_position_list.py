...
class InventoryPositionList(BaseModel):
    """
    Список позиций Инвентаризации
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[InventoryPosition]] = Field(default=None, description="Массив позиций Инвентаризации")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [InventoryPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
