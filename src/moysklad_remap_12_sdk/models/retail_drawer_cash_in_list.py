...
class RetailDrawerCashInList(BaseModel):
    """
    Список Внесений денег
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[RetailDrawerCashIn]] = Field(default=None, description="Массив Внесений денег")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [RetailDrawerCashIn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
