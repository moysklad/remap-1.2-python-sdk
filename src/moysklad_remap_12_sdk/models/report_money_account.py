...
class ReportMoneyAccount(BaseModel):
    """
    Краткое представление счета организации в отчете «Деньги»
    """ # noqa: E501
    meta: Optional[Meta] = None
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Номер счета")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "name"]
