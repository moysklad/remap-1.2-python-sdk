...
class CustomEntityElementList(BaseModel):
    """
    Список элементов пользовательского справочника
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[CustomEntityElement]] = Field(default=None, description="Массив элементов пользовательского справочника")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CustomEntityElement.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
