...
class StoreBalanceList(BaseModel):
    """
    Неснижаемые остатки по складам
    """ # noqa: E501
    meta: Optional[MetaList] = None
    rows: Optional[List[StoreBalance]] = Field(default=None, description="Массив элементов списка")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [StoreBalance.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
