...
class RegionList(BaseModel):
    ...
    rows: Optional[List[Region]] = Field(default=None, description="Массив регионов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Region.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
