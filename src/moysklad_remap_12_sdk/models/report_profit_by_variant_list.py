...
class ReportProfitByVariantList(BaseModel):
    """
    Отчет «Прибыльность по модификациям»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportProfitByVariant]] = Field(default=None, description="Массив строк отчета прибыльности по модификациям")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportProfitByVariant.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
