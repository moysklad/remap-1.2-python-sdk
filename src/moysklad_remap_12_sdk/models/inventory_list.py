...
class InventoryList(BaseModel):
    ...
    rows: Optional[List[Inventory]] = Field(default=None, description="Массив Инвентаризаций")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Inventory.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
