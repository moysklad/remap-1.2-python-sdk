...
class GetVariantCharacteristics200Response(BaseModel):
    """
    GetVariantCharacteristics200Response
    """ # noqa: E501
    meta: Optional[Meta] = None
    rows: Optional[List[VariantCharacteristic]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [VariantCharacteristic.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
