...
class NotificationTaskCommentDiff(BaseModel):
    """
    Изменение текста комментария к задаче
    """ # noqa: E501
    note_content: Optional[NotificationDiffValue] = Field(default=None, alias="noteContent")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["noteContent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.note_content:
            _dict['noteContent'] = self.note_content.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "noteContent": NotificationDiffValue.from_dict(obj["noteContent"]) if obj.get("noteContent") is not None else None
        })
