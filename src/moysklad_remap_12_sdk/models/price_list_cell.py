...
class PriceListCell(BaseModel):
    """
    Ячейка позиции Прайс-листа
    """ # noqa: E501
    column: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Название столбца, к которому относится данная ячейка")
    sum: Optional[StrictInt] = Field(default=None, description="Числовое значение ячейки")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["column", "sum"]
