...
class CreateLossPositions200ResponseInner(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateLossPositions200ResponseInner.model_construct()
        error_messages = []
        match = 0
        # validate data type: LossPosition
        if not isinstance(v, LossPosition):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into LossPosition
        try:
            instance.actual_instance = LossPosition.from_json(json_str)
            match += 1
