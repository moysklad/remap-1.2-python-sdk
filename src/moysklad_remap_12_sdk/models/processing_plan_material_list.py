...
class ProcessingPlanMaterialList(BaseModel):
    """
    Список материалов Техкарты
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingPlanMaterial]] = Field(default=None, description="Массив материалов Техкарты")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingPlanMaterial.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
...
ProcessingPlanMaterialList.model_rebuild(raise_errors=False)
