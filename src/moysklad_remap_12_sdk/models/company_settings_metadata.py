...
class CompanySettingsMetadata(BaseModel):
    """
    Метаданные Настроек компании (companysettings/metadata)
    """ # noqa: E501
    meta: Optional[Meta] = None
    custom_entities: Optional[List[CustomEntityMetadata]] = Field(default=None, description="Список пользовательских справочников", alias="customEntities")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "customEntities"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.custom_entities:
            for _item_custom_entities in self.custom_entities:
                if _item_custom_entities:
                    _items.append(_item_custom_entities.to_dict())
            _dict['customEntities'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "customEntities": [CustomEntityMetadata.from_dict(_item) for _item in obj["customEntities"]] if obj.get("customEntities") is not None else None
        })
