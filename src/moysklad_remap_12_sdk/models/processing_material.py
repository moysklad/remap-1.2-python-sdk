...
class ProcessingMaterial(BaseModel):
    """
    Материал техоперации
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID материала техоперации")
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "assortment", "quantity", "things"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/processing" + "/" + parentId + "/materials" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
