...
class CommissionReportInCommissionOverhead(BaseModel):
    """
    Прочие расходы
    """ # noqa: E501
    sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Сумма НДС")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sum"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommissionReportInCommissionOverhead from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommissionReportInCommissionOverhead from a dict"""
        if obj is None:
            return None
