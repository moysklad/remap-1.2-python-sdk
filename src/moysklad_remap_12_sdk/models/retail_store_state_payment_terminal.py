...
class RetailStoreStatePaymentTerminal(BaseModel):
    """
    Информация о платежном терминале
    """ # noqa: E501
    acquiring_type: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Тип эквайринга", alias="acquiringType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["acquiringType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "acquiringType": obj.get("acquiringType")
        })
