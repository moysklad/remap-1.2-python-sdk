...
class RetailStoreStateFiscalMemory(BaseModel):
    """
    Статус фискальной памяти
    """ # noqa: E501
    error: Optional[RetailStoreStateFiscalMemoryError] = None
    not_send_doc_count: Optional[StrictInt] = Field(default=None, description="Количество неотправленных документов", alias="notSendDocCount")
    not_send_first_doc_moment: Optional[StrictStr] = Field(default=None, description="Момент первого неотправленного документа", alias="notSendFirstDocMoment")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["error", "notSendDocCount", "notSendFirstDocMoment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "error": RetailStoreStateFiscalMemoryError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "notSendDocCount": obj.get("notSendDocCount"),
            "notSendFirstDocMoment": obj.get("notSendFirstDocMoment")
        })
