...
class ReportTurnoverAssortment(BaseModel):
    """
    Краткое представление номенклатуры в отчете «Обороты»
    """ # noqa: E501
    meta: Optional[Meta] = None
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование номенклатуры")
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код Товара")
    article: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Артикул Товара")
    image: Optional[Image] = None
    product_folder: Optional[ProductFolder] = Field(default=None, alias="productFolder")
    uom: Optional[Uom] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "name", "code", "article", "image", "productFolder", "uom"]
