...
class ReportTurnoverByStoreList(BaseModel):
    """
    Отчет «Обороты по товару с детализацией по складам»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportTurnoverByStore]] = Field(default=None, description="Массив строк отчета оборотов с детализацией по складам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportTurnoverByStore.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
