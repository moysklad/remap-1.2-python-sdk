...
class ProjectList(BaseModel):
    ...
    rows: Optional[List[Project]] = Field(default=None, description="Массив проектов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Project.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
