...
class FacebookTokenExpirationNotification(NotificationAbstract):
    """
    Уведомление об окончании доступа к аккаунту Facebook
    """ # noqa: E501
    connector_name: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Название коннектора", alias="connectorName")
    days_left_to_expiration: Optional[StrictInt] = Field(default=None, description="Количество дней до окончания доступа", alias="daysLeftToExpiration")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["connectorName", "daysLeftToExpiration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "daysLeftToExpiration": obj.get("daysLeftToExpiration")
        })
