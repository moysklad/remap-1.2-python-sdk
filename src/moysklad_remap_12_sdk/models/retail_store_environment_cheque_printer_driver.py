...
class RetailStoreEnvironmentChequePrinterDriver(BaseModel):
    """
    Информация о драйвере
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование драйвера")
    version: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Версия драйвера")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetailStoreEnvironmentChequePrinterDriver from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetailStoreEnvironmentChequePrinterDriver from a dict"""
        if obj is None:
            return None
