...
class RetailStoreList(BaseModel):
    """
    Список точек продаж
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[RetailStore]] = Field(default=None, description="Массив точек продаж")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [RetailStore.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
...
RetailStoreList.model_rebuild(raise_errors=False)
