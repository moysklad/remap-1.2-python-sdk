...
class StockAllList(BaseModel):
    """
    Расширенный отчет об остатках
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[StockAll]] = Field(default=None, description="Массив строк отчета об остатках. Набор типов строк зависит от параметра запроса `groupBy` (см. `meta.type`: product, variant, consignment). ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [StockAll.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
