...
class MoveList(BaseModel):
    ...
    rows: Optional[List[Move]] = Field(default=None, description="Массив Перемещений")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Move.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
