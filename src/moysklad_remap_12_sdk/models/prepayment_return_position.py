...
class PrepaymentReturnPosition(EntityWithMeta):
    """
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "assortment", "discount", "pack", "price", "quantity", "vat", "vatEnabled"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/prepaymentreturn" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
