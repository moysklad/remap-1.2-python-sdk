...
class ReportTurnoverByOperationList(BaseModel):
    """
    Отчет «Обороты по товару с детализацией по документам»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportTurnoverByOperation]] = Field(default=None, description="Массив строк отчета оборотов с детализацией по документам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportTurnoverByOperation.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
