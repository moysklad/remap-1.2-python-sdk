...
class ReportProfitByEmployeeList(BaseModel):
    """
    Отчет «Прибыльность по сотрудникам»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportProfitByEmployee]] = Field(default=None, description="Массив строк отчета прибыльности по сотрудникам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportProfitByEmployee.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
