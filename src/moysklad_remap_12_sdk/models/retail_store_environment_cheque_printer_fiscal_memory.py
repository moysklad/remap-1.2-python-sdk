...
class RetailStoreEnvironmentChequePrinterFiscalMemory(BaseModel):
    """
    Фискальная память
    """ # noqa: E501
    ...
    fiscal_validity_date: Optional[StrictStr] = Field(default=None, description="Дата окончания действия фискальной памяти", alias="fiscalValidityDate")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["fiscalDataVersion", "fiscalValidityDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "fiscalValidityDate": obj.get("fiscalValidityDate")
        })
