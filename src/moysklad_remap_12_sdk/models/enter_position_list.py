...
class EnterPositionList(BaseModel):
    """
    Список позиций Оприходования
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[EnterPosition]] = Field(default=None, description="Массив позиций Оприходования")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [EnterPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
