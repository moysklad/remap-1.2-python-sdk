...
class PaymentOutList(BaseModel):
    ...
    rows: Optional[List[PaymentOut]] = Field(default=None, description="Массив Исходящих платежей")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [PaymentOut.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
