...
class CashOutList(BaseModel):
    ...
    rows: Optional[List[CashOut]] = Field(default=None, description="Массив Расходных ордеров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CashOut.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
