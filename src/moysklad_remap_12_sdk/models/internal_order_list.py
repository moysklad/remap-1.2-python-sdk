...
class InternalOrderList(BaseModel):
    """
    Список Внутренних заказов
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[InternalOrder]] = Field(default=None, description="Массив Внутренних заказов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [InternalOrder.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
