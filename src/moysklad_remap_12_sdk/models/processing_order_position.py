...
class ProcessingOrderPosition(EntityWithMeta):
    """
    ...
    quantity: Optional[Union[Annotated[float, Field(strict=True, ge=0.0000010)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="Количество товаров данного вида в позиции")
    reserve: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Резерв данной позиции")
    assortment: Optional[ProductMarker] = Field(default=None, description="Метаданные товара/услуги/партии/модификации позиции")
    pack: Optional[Pack] = Field(default=None, description="Упаковка Товара")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "quantity", "reserve", "assortment", "pack"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/processingorder" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
