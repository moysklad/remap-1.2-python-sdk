...
class Overhead(BaseModel):
    ...
    """ # noqa: E501
    sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Сумма в копейках")
    distribution: Optional[StrictStr] = Field(default=None, description="Распределение накладных расходов. Возможные значения описаны в OverheadDistribution")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sum", "distribution"]
