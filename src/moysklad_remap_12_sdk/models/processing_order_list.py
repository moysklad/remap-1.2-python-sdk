...
class ProcessingOrderList(BaseModel):
    """
    Список Заказов на производство
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingOrder]] = Field(default=None, description="Массив Заказов на производство")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingOrder.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
