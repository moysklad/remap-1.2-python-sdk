...
class PayrollList(BaseModel):
    ...
    rows: Optional[List[Payroll]] = Field(default=None, description="Массив Начислений зарплаты")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Payroll.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
