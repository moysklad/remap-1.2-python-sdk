...
class ProcessingPlanProduct(BaseModel):
    """
    Продукт Техкарты
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID продукта Техкарты")
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "assortment", "product", "quantity"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/processingplan" + "/" + parentId + "/products" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
