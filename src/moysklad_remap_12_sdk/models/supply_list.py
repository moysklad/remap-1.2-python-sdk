...
class SupplyList(BaseModel):
    ...
    rows: Optional[List[Supply]] = Field(default=None, description="Массив Приемок")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Supply.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
