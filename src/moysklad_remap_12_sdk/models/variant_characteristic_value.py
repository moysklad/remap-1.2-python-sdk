...
class VariantCharacteristicValue(BaseModel):
    """
    ...
    value: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Значение Характеристики")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "name", "value"]
