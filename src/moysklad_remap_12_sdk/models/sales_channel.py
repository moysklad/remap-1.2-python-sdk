...
class SalesChannel(EntityWithMeta):
    """
    Канал продаж
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID Канала продаж")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    archived: Optional[StrictBool] = Field(default=None, description="Добавлен ли Канал продаж в архив")
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код Канала продаж")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Описание Канала продаж")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Канала продаж", alias="externalCode")
    group: Optional[Group] = None
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Канала продаж")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Тип Канала продаж. Известные значения описаны в SalesChannelType")
    updated: Optional[StrictStr] = Field(default=None, description="Момент последнего обновления сущности")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "archived", "code", "description", "externalCode", "group", "name", "owner", "shared", "type", "updated"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/saleschannel" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
