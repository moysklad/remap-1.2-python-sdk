...
class PublicationList(BaseModel):
    ...
    rows: Optional[List[Publication]] = Field(default=None, description="Список Публикаций Заказа покупателя")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Publication.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
