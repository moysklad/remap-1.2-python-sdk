...
class PriceListPosition(EntityWithMeta):
    """
    Позиция Прайс-листа
    """ # noqa: E501
    ...
    assortment: Optional[ProductMarker] = Field(default=None, description="Метаданные номенклатуры, которую представляет собой позиция")
    cells: Optional[List[PriceListCell]] = Field(default=None, description="Массив значений столбцов в позиции Прайс-листа")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "assortment", "cells"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/pricelist" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "cells": [PriceListCell.from_dict(_item) for _item in obj["cells"]] if obj.get("cells") is not None else None
        })
