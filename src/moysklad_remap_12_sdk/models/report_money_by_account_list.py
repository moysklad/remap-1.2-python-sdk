...
class ReportMoneyByAccountList(BaseModel):
    """
    Отчет об остатках денежных средств по кассам и счетам
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[Meta] = None
    rows: Optional[List[ReportMoneyByAccount]] = Field(default=None, description="Массив строк отчета об остатках денежных средств")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportMoneyByAccount.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
