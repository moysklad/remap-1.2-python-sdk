...
class ReportTurnoverOperation(BaseModel):
    """
    Документ, связанный с Товаром
    """ # noqa: E501
    meta: Optional[Meta] = None
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Номер документа")
    description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Комментарий к документу")
    moment: Optional[StrictStr] = Field(default=None, description="Дата проведения документа")
    agent: Optional[Agent] = Field(default=None, description="Контрагент документа")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "name", "description", "moment", "agent"]
