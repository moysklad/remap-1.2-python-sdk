...
class AssortmentList(BaseModel):
    """
    Список ассортимента
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[Assortment]] = Field(default=None, description="Массив элементов ассортимента")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Assortment.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
