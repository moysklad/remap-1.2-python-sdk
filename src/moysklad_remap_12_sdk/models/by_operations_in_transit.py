...
class ByOperationsInTransit(BaseModel):
    """
    ...
    in_transit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Ожидания", alias="inTransit")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["assortment", "operation", "moment", "store", "inTransit"]
