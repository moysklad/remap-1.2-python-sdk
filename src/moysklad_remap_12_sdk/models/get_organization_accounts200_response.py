...
class GetOrganizationAccounts200Response(BaseModel):
    """
    GetOrganizationAccounts200Response
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[Account]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Account.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
