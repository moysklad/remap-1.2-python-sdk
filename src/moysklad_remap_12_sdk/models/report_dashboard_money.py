...
class ReportDashboardMoney(BaseModel):
    """
    ...
    movement: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Дельта за период")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["income", "outcome", "balance", "todayMovement", "movement"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "todayMovement": obj.get("todayMovement"),
