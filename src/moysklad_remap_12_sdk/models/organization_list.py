...
class OrganizationList(BaseModel):
    ...
    rows: Optional[List[Organization]] = Field(default=None, description="Массив юрлиц")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Organization.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
