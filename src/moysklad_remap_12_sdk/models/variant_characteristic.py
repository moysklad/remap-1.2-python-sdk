...
class VariantCharacteristic(BaseModel):
    """
    Характеристики модификаций
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID соответствующей Характеристики")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Характеристики")
    type: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Тип значения Характеристики. Известные значения описаны в VariantCharacteristicType")
    required: Optional[StrictBool] = Field(default=None, description="Обязательность указания Характеристики в модификации")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "name", "type", "required"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/variant" + "/metadata" + "/characteristics" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
