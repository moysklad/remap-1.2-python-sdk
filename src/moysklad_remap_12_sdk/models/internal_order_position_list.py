...
class InternalOrderPositionList(BaseModel):
    """
    Список позиций Внутреннего заказа
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[InternalOrderPosition]] = Field(default=None, description="Массив позиций Внутреннего заказа")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [InternalOrderPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
