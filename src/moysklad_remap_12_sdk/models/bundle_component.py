...
class BundleComponent(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID компонента комплекта")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Количество товаров/услуг/модификаций данного вида в компоненте")
    assortment: Optional[AssortmentWithoutBundle] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "quantity", "assortment"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/bundle" + "/" + parentId + "/components" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "assortment": AssortmentWithoutBundle.from_dict(obj["assortment"]) if obj.get("assortment") is not None else None
        })
