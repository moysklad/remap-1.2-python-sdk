...
class SupplyPosition(EntityWithMeta):
    """
    Позиция Приемки
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "assortment", "country", "discount", "gtd", "pack", "price", "quantity", "slot", "things", "trackingCodes", "overhead", "vat", "vatEnabled"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/supply" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.gtd is None and "gtd" in self.model_fields_set:
            _dict['gtd'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "gtd": Gtd.from_dict(obj["gtd"]) if obj.get("gtd") is not None else None,
