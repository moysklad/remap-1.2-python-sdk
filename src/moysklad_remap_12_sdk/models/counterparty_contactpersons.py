...
class CounterpartyContactpersons(BaseModel):
    """
    Массив контактных лиц
    """ # noqa: E501
    meta: Optional[MetaList] = None
    rows: Optional[List[ContactPerson]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ContactPerson.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
...
CounterpartyContactpersons.model_rebuild(raise_errors=False)
