...
class DeclarationInner(BaseModel):
    """
    Запись о прослеживаемости импортных товаров
    """ # noqa: E501
    gtd: Optional[StrictStr] = Field(default=None, description="Грузовая таможенная декларация")
    rnpt: Optional[StrictStr] = Field(default=None, description="Регистрационный номер партии товара (прослеживаемый товар)")
    country: Optional[Country] = Field(default=None, description="Страна происхождения товара")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Количество товара с указанными ГТД или РНПТ в позиции документа")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["gtd", "rnpt", "country", "quantity"]
