...
class AttributeCustomEntity(AttributeAbstract):
    """
    AttributeCustomEntity
    """ # noqa: E501
    type: Optional[StrictStr] = None
    value: Optional[CustomEntityElement] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['customentity']):
            raise ValueError("must be one of enum values ('customentity')")
        return value
