...
class ProcessingProcess(EntityWithMeta):
    """
    Техпроцесс
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID Техпроцесса")
    ...
    updated: Optional[StrictStr] = Field(default=None, description="Момент последнего обновления Техпроцесса")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Техпроцесса")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Комментарий Техпроцесса")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Техпроцесса", alias="externalCode")
    archived: Optional[StrictBool] = Field(default=None, description="Добавлен ли Техпроцесс в архив")
    positions: Optional[ProcessingProcessPositionList] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "owner", "shared", "group", "updated", "name", "description", "externalCode", "archived", "positions"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/processingprocess" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "positions": ProcessingProcessPositionList.from_dict(obj["positions"]) if obj.get("positions") is not None else None
        })
