...
class RetailSalesReturnPositionList(BaseModel):
    """
    Список позиций Розничного возврата
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = Field(default=None, description="Метаданные о выдаче")
    rows: Optional[List[RetailSalesReturnPosition]] = Field(default=None, description="Массив позиций Розничного возврата")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [RetailSalesReturnPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
