...
class NotificationDeletedTask(BaseModel):
    """
    Краткое представление удаленной задачи
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование задачи")
