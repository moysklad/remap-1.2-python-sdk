...
class DemandList(BaseModel):
    ...
    rows: Optional[List[Demand]] = Field(default=None, description="Массив Отгрузок")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Demand.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
