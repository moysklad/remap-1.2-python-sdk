...
class BonusProgramList(BaseModel):
    """
    Список бонусных программ
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[BonusProgram]] = Field(default=None, description="Массив бонусных программ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [BonusProgram.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
