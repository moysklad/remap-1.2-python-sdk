...
class ProcessingOrderPositionList(BaseModel):
    """
    Список позиций Заказа на производство
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingOrderPosition]] = Field(default=None, description="Массив позиций Заказа на производство")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingOrderPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
