...
class ProductFolderList(BaseModel):
    """
    Список группы товаров
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProductFolder]] = Field(default=None, description="Массив группы товаров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProductFolder.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
...
ProductFolderList.model_rebuild(raise_errors=False)
