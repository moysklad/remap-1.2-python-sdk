...
class RetailStoreStateSync(BaseModel):
    """
    Состояние синхронизации
    """ # noqa: E501
    message: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Сообщение")
    last_attemp_moment: Optional[StrictStr] = Field(default=None, description="Момент последней попытки", alias="lastAttempMoment")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message", "lastAttempMoment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "lastAttempMoment": obj.get("lastAttempMoment")
        })
