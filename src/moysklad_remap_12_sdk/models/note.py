...
class Note(BaseModel):
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Текст события Контрагента")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "agent", "author", "authorApplication", "created", "description"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/counterparty" + "/" + parentId + "/notes" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
