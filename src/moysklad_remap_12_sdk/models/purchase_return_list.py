...
class PurchaseReturnList(BaseModel):
    """
    Список Возвратов поставщикам
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[PurchaseReturn]] = Field(default=None, description="Массив Возвратов поставщикам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [PurchaseReturn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
