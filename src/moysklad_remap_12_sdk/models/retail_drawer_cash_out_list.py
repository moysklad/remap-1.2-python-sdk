...
class RetailDrawerCashOutList(BaseModel):
    """
    Список Выплат денег
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[RetailDrawerCashOut]] = Field(default=None, description="Массив Выплат денег")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [RetailDrawerCashOut.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
