...
class WebhookList(BaseModel):
    ...
    rows: Optional[List[Webhook]] = Field(default=None, description="Массив вебхуков")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Webhook.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
