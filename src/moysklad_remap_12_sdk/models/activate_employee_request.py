...
class ActivateEmployeeRequest(BaseModel):
    ...
    """ # noqa: E501
    login: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Логин сотрудника (обязателен при первой активации)")
    group: Optional[Group] = None
    role: Optional[EmployeeRole] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["login", "group", "role"]
