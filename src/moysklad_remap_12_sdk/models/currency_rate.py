...
class CurrencyRate(BaseModel):
    ...
    Валюта
    """ # noqa: E501
    currency: Optional[Currency] = Field(default=None, description="""Валюта""", alias="currency")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Курс валюты")
