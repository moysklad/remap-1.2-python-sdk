...
class AssortmentSettingsUniqueCodeRules(BaseModel):
    """
    Настройки уникальности кода для сущностей ассортимента
    """ # noqa: E501
    check_unique_code: Optional[StrictBool] = Field(default=None, description="Проверка уникальности кода сущностей ассортимента", alias="checkUniqueCode")
    fill_unique_code: Optional[StrictBool] = Field(default=None, description="Устанавливать уникальный код при создании сущностей ассортимента", alias="fillUniqueCode")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["checkUniqueCode", "fillUniqueCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "checkUniqueCode": obj.get("checkUniqueCode"),
            "fillUniqueCode": obj.get("fillUniqueCode")
        })
