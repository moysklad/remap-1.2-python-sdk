...
class WebhookEvent(BaseModel):
    ...
    action: Optional[StrictStr] = Field(default=None, description="Действие, вызвавшее срабатывание. Известные значения описаны в WebhookAction")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    updated_fields: Optional[List[StrictStr]] = Field(default=None, description="Поля сущности, измененные пользователем (при diffType=FIELDS и action=UPDATE у настройки вебхука)", alias="updatedFields")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "action", "accountId", "updatedFields"]
