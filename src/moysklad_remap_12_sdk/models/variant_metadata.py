...
class VariantMetadata(BaseModel):
    ...
    characteristics: Optional[List[VariantCharacteristic]] = Field(default=None, description="Характеристики Модификации")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "characteristics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "characteristics": [VariantCharacteristic.from_dict(_item) for _item in obj["characteristics"]] if obj.get("characteristics") is not None else None
        })
