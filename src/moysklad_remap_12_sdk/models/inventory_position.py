...
class InventoryPosition(EntityWithMeta):
    """
    ...
    calculated_quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Расчетный остаток", alias="calculatedQuantity")
    correction_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Разница между расчетным остатком и фактическим", alias="correctionAmount")
    correction_sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Избыток/недостача", alias="correctionSum")
    ...
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Количество товаров/услуг данного вида в позиции. Если позиция - товар,  у которого включен учет по серийным номерам, то значение в этом поле всегда  будет равно количеству серийных номеров для данной позиции в документе. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "assortment", "calculatedQuantity", "correctionAmount", "correctionSum", "pack", "price", "things", "quantity"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/inventory" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "calculatedQuantity": obj.get("calculatedQuantity"),
            "correctionAmount": obj.get("correctionAmount"),
            "correctionSum": obj.get("correctionSum"),
