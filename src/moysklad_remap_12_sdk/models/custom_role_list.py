...
class CustomRoleList(BaseModel):
    ...
    rows: Optional[List[CustomRole]] = Field(default=None, description="Массив пользовательских ролей")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CustomRole.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
