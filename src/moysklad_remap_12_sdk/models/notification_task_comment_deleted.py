...
class NotificationTaskCommentDeleted(NotificationAbstract):
    """
    Уведомление об удалении комментария к задаче
    """ # noqa: E501
    note_content: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Содержимое удаленного комментария", alias="noteContent")
    ...
    __properties: ClassVar[List[str]] = ["noteContent", "performedBy", "task"]
