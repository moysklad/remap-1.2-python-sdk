...
class NotificationChannelSettings(BaseModel):
    ...
    """ # noqa: E501
    email: Optional[StrictBool] = Field(default=None, description="Признак активности доставки уведомлений по электронной почте")
    push: Optional[StrictBool] = Field(default=None, description="Признак активности доставки уведомлений через мобильные push-уведомления")
    interface: Optional[StrictBool] = Field(default=None, description="Признак активности доставки уведомлений в веб-интерфейсе")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["email", "push", "interface"]
