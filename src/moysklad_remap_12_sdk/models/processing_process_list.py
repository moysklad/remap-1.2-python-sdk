...
class ProcessingProcessList(BaseModel):
    """
    Список Техпроцессов
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingProcess]] = Field(default=None, description="Массив Техпроцессов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingProcess.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
