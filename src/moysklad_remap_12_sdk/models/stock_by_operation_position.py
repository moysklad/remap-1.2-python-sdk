...
class StockByOperationPosition(BaseModel):
    """
    Остаток по позиции в отчете «Остатки по документам»
    """ # noqa: E501
    meta: Optional[Meta] = None
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование позиции")
    stock: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Остаток")
    cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Себестоимость в копейках")
    in_transit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Ожидание. У сущности Комплект значение всегда `0`", alias="inTransit")
    reserve: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Резерв. У сущности Комплект значение всегда `0`")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Доступно. У сущности Комплект значение всегда `0`")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "name", "stock", "cost", "inTransit", "reserve", "quantity"]
