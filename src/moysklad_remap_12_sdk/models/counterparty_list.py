...
class CounterpartyList(BaseModel):
    ...
    rows: Optional[List[Counterparty]] = Field(default=None, description="Массив контрагентов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Counterparty.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
