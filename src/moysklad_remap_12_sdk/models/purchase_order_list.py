...
class PurchaseOrderList(BaseModel):
    ...
    rows: Optional[List[PurchaseOrder]] = Field(default=None, description="Массив Заказов поставщику")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [PurchaseOrder.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
