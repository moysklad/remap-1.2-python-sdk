...
class RetailStoreStateFiscalMemoryError(BaseModel):
    """
    Ошибка фискальной памяти
    """ # noqa: E501
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код ошибки")
    message: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Сообщение ошибки")
