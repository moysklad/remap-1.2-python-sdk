...
class ActivateEmployee200Response(BaseModel):
    """
    ActivateEmployee200Response
    """ # noqa: E501
    mail_activation_required: Optional[StrictBool] = Field(default=None, description="Признак того, что на почту сотрудника выслано письмо для активации", alias="mailActivationRequired")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["mailActivationRequired"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "mailActivationRequired": obj.get("mailActivationRequired")
        })
