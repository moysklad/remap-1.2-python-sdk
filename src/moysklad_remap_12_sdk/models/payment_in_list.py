...
class PaymentInList(BaseModel):
    ...
    rows: Optional[List[PaymentIn]] = Field(default=None, description="Массив Входящих платежей")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [PaymentIn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
