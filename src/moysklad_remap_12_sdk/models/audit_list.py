...
class AuditList(BaseModel):
    ...
    rows: Optional[List[Audit]] = Field(default=None, description="Массив контекстов аудита")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Audit.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
