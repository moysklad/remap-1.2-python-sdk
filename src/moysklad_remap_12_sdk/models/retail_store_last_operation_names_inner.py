...
class RetailStoreLastOperationNamesInner(BaseModel):
    """
    Последние операции
    """ # noqa: E501
    entity: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Ключевое слово, обозначающее тип последней операции")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование (номер) последней операции")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["entity", "name"]
