...
class InvoiceInList(BaseModel):
    ...
    rows: Optional[List[InvoiceIn]] = Field(default=None, description="Массив Счетов поставщикам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [InvoiceIn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
