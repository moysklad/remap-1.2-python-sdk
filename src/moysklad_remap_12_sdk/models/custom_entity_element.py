...
class CustomEntityElement(BaseModel):
    """
    Элемент пользовательского справочника (customentity)
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID элемента пользовательского справочника")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    updated: Optional[StrictStr] = Field(default=None, description="Момент последнего обновления элемента")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование элемента пользовательского справочника")
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код элемента пользовательского справочника")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Описание элемента пользовательского справочника")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код элемента пользовательского справочника", alias="externalCode")
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "updated", "name", "code", "description", "externalCode", "attributes", "owner", "shared", "group"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/customentity" + "/" + metadataId + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.external_code is None and "external_code" in self.model_fields_set:
            _dict['externalCode'] = None
