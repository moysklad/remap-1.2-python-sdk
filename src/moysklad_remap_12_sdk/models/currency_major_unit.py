...
class CurrencyMajorUnit(BaseModel):
    """
    Формы единиц целой части Валюты
    """ # noqa: E501
    gender: Optional[StrictStr] = Field(default=None, description="Пол. Известные значения описаны в Gender")
    s1: Optional[StrictStr] = Field(default=None, description="Форма единицы, используемая при числительном 1")
    s2: Optional[StrictStr] = Field(default=None, description="Форма единицы, используемая при числительном 2")
    s5: Optional[StrictStr] = Field(default=None, description="Форма единицы, используемая при числительном 5")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["gender", "s1", "s2", "s5"]
