...
class ReportTurnoverIndicators(BaseModel):
    """
    Показатели оборотов
    """ # noqa: E501
    sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Сумма себестоимости в копейках")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Количество единиц товара")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sum", "quantity"]
