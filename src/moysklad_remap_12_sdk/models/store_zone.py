...
class StoreZone(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID Зоны склада")
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Зоны склада")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Зоны склада", alias="externalCode")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "updated", "name", "externalCode"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/store" + "/" + parentId + "/zones" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
