...
class ConsignmentList(BaseModel):
    """
    Список Партий
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[Consignment]] = Field(default=None, description="Массив Партий")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Consignment.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
