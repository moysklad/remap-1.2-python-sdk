...
class RetailDemandPositionList(BaseModel):
    """
    Список позиций Розничной продажи
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = Field(default=None, description="Метаданные о выдаче")
    rows: Optional[List[RetailDemandPosition]] = Field(default=None, description="Массив позиций Розничной продажи")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [RetailDemandPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
