...
class ReportCounterpartyList(BaseModel):
    """
    Отчет «Показатели контрагентов»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportCounterparty]] = Field(default=None, description="Массив JSON объектов, представляющих отчеты по отдельным контрагентам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportCounterparty.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
