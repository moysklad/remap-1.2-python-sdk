...
class ReportMoneyByAccount(BaseModel):
    """
    Строка отчета об остатках денежных средств по кассам и счетам
    """ # noqa: E501
    account: Optional[ReportMoneyAccount] = None
    organization: Optional[Organization] = None
    balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Текущий остаток денежных средств в валюте счета")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["account", "organization", "balance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "account": ReportMoneyAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
