...
class NotificationTaskDeleted(NotificationAbstract):
    """
    Уведомление об удалении задачи
    """ # noqa: E501
    performed_by: Optional[NotificationNamedEntity] = Field(default=None, alias="performedBy")
    task: Optional[NotificationDeletedTask] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["performedBy", "task"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "task": NotificationDeletedTask.from_dict(obj["task"]) if obj.get("task") is not None else None
        })
