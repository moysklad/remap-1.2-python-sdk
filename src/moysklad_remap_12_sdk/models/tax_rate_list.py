...
class TaxRateList(BaseModel):
    ...
    rows: Optional[List[TaxRate]] = Field(default=None, description="Массив ставок НДС")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [TaxRate.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
