...
class TaskNoteList(BaseModel):
    """
    Список комментариев к Задаче
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[TaskNote]] = Field(default=None, description="Массив комментариев к Задаче")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [TaskNote.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
