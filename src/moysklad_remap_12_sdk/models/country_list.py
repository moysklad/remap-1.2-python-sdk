...
class CountryList(BaseModel):
    ...
    rows: Optional[List[Country]] = Field(default=None, description="Массив стран")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Country.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
