...
class SalePlatformList(BaseModel):
    """
    Список площадок для продаж
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[SalePlatform]] = Field(default=None, description="Массив площадок для продаж")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [SalePlatform.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
