...
class NotificationRetailShift(BaseModel):
    """
    ...
    open: Optional[StrictStr] = Field(default=None, description="Дата открытия смены")
    close: Optional[StrictStr] = Field(default=None, description="Дата закрытия смены")
    proceed: Optional[StrictInt] = Field(default=None, description="Выручка смены")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "name", "open", "close", "proceed"]
