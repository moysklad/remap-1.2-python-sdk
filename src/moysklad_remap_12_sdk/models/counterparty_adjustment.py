...
class CounterpartyAdjustment(EntityWithMeta):
    """
    Корректировка взаиморасчетов
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID Корректировки взаиморасчетов")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    agent: Optional[Agent] = Field(default=None, description="Метаданные контрагента или сотрудника")
    ...
    deleted: Optional[StrictStr] = Field(default=None, description="Момент последнего удаления Корректировки взаиморасчетов")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Комментарий Корректировки взаиморасчетов")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Корректировки взаиморасчетов", alias="externalCode")
    files: Optional[FileList] = Field(default=None, description="Метаданные массива Файлов (максимум 100)")
    group: Optional[Group] = None
    moment: Optional[StrictStr] = Field(default=None, description="Дата документа")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Корректировки взаиморасчетов")
    ...
    sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Сумма Корректировки взаиморасчетов в копейках")
    updated: Optional[StrictStr] = Field(default=None, description="Момент последнего обновления Корректировки взаиморасчетов")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "agent", "applicable", "attributes", "created", "deleted", "description", "externalCode", "files", "group", "moment", "name", "organization", "owner", "printed", "published", "shared", "sum", "updated"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/counterpartyadjustment" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
