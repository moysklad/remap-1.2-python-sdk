...
class ProcessingStageList(BaseModel):
    """
    Список Этапов производства
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingStage]] = Field(default=None, description="Массив Этапов производства")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingStage.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
