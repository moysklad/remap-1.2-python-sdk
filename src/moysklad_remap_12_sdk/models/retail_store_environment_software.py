...
class RetailStoreEnvironmentSoftware(BaseModel):
    """
    Информация о ПО
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование ПО")
    vendor: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Производитель ПО")
    version: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Версия ПО")
