...
class RetailDemandGiftCard(BaseModel):
    """
    Подарочный сертификат, используемый при оплате розничной продажи
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Номер сертификата")
    payment_sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Сумма сертификата", alias="paymentSum")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "paymentSum"]
