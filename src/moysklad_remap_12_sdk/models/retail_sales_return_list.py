...
class RetailSalesReturnList(BaseModel):
    """
    Список Розничных возвратов
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[RetailSalesReturn]] = Field(default=None, description="Массив Розничных возвратов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [RetailSalesReturn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
