...
class EmployeeList(BaseModel):
    ...
    rows: Optional[List[Employee]] = Field(default=None, description="Массив сотрудников")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Employee.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
