...
class EmissionOrderPositionList(BaseModel):
    """
    Список позиций Заказа кодов маркировки
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[EmissionOrderPosition]] = Field(default=None, description="Массив позиций Заказа кодов маркировки")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [EmissionOrderPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
