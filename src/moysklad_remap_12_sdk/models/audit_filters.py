...
class AuditFilters(BaseModel):
    ...
    """ # noqa: E501
    source: Optional[List[AuditSourceType]] = Field(default=None, description="Источники изменений, доступные для фильтрации")
    entitytype: Optional[List[StrictStr]] = Field(default=None, description="Типы сущностей, доступные для фильтрации")
    eventtype: Optional[List[AuditEventType]] = Field(default=None, description="Типы событий, доступные для фильтрации")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["source", "entitytype", "eventtype"]
