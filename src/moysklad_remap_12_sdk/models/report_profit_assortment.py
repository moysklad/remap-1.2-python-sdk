...
class ReportProfitAssortment(BaseModel):
    """
    Краткое представление товара, модификации, услуги или комплекта
    """ # noqa: E501
    meta: Optional[Meta] = None
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование сущности")
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код сущности")
    uom: Optional[Uom] = None
    article: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Артикул товара, модификации или комплекта")
    image: Optional[Image] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "name", "code", "uom", "article", "image"]
