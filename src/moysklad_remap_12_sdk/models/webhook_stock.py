...
class WebhookStock(EntityWithMeta):
    """
    Вебхук на изменение остатков
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID вебхука на изменение остатков")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    stock_type: Optional[StrictStr] = Field(default=None, description="Тип остатков. Известные значения описаны в WebhookStockStockType", alias="stockType")
    report_type: Optional[StrictStr] = Field(default=None, description="Тип отчёта остатков. Известные значения описаны в WebhookStockReportType", alias="reportType")
    url: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="URL, по которому будет происходить обработка вебхука")
    enabled: Optional[StrictBool] = Field(default=None, description="Вебхук включён или отключён")
    author_application: Optional[Application] = Field(default=None, alias="authorApplication")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "stockType", "reportType", "url", "enabled", "authorApplication"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/webhookstock" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
