...
class ProcessingProduct(BaseModel):
    """
    Продукт техоперации
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID продукта техоперации")
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/processing" + "/" + parentId + "/products" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
