...
class RetailShiftOperationRetailDrawerCashIn(RetailShiftOperation):
    """
    Внесение денег
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID Внесения денег")
    ...
    deleted: Optional[StrictStr] = Field(default=None, description="Момент последнего удаления Внесения денег")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Комментарий Внесения денег")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Внесения денег", alias="externalCode")
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Внесения денег")
    ...
    state: Optional[State] = Field(default=None, description="Метаданные статуса Внесения денег")
    sum: Optional[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="Сумма Внесения денег в копейках")
    sync_id: Optional[StrictStr] = Field(default=None, description="ID синхронизации", alias="syncId")
    updated: Optional[StrictStr] = Field(default=None, description="Момент последнего обновления Внесения денег")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "agent", "applicable", "attributes", "created", "deleted", "description", "externalCode", "files", "group", "moment", "name", "organization", "owner", "printed", "published", "rate", "retailShift", "shared", "state", "sum", "syncId", "updated"]
