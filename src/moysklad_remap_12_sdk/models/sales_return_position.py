...
class SalesReturnPosition(EntityWithMeta):
    """
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "assortment", "cost", "country", "discount", "gtd", "pack", "price", "quantity", "slot", "things", "vat", "vatEnabled"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/salesreturn" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
