...
class Barcode(BaseModel):
    ...
    Штрихкод
    """ # noqa: E501
    ean13: Optional[StrictStr] = Field(default=None, description="Штрихкод в формате EAN13")
    ean8: Optional[StrictStr] = Field(default=None, description="Штрихкод в формате EAN8")
    code128: Optional[StrictStr] = Field(default=None, description="Штрихкод в формате Code128")
    gtin: Optional[StrictStr] = Field(default=None, description="Штрихкод в формате GTIN")
    upc: Optional[StrictStr] = Field(default=None, description="Штрихкод в формате UPC")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ean13", "ean8", "code128", "gtin", "upc"]
