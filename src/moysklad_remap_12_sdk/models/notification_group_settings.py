...
class NotificationGroupSettings(BaseModel):
    ...
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Признак активности подписки на группу уведомлений")
    channels_enabled: Optional[NotificationChannelSettings] = Field(default=None, alias="channelsEnabled")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "channelsEnabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.channels_enabled:
            _dict['channelsEnabled'] = self.channels_enabled.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "channelsEnabled": NotificationChannelSettings.from_dict(obj["channelsEnabled"]) if obj.get("channelsEnabled") is not None else None
        })
