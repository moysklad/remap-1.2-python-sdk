...
class ReportTurnoverByOperation(BaseModel):
    """
    Строка отчета «Обороты по товару с детализацией по документам»
    """ # noqa: E501
    assortment: Optional[ReportTurnoverAssortment] = None
    store: Optional[Store] = None
    operation: Optional[ReportTurnoverOperation] = None
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Количество номенклатуры в документе")
    cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Себестоимость номенклатуры в копейках в документе")
    sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Сумма себестоимостей в копейках")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["assortment", "store", "operation", "quantity", "cost", "sum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "operation": ReportTurnoverOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
