...
class PurchaseOrderPosition(EntityWithMeta):
    """
    ...
    shipped: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Принято")
    ...
    assortment: Optional[ProductMarker] = Field(default=None, description="Метаданные товара/услуги/модификации/партии, которую представляет собой позиция")
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "quantity", "price", "discount", "shipped", "inTransit", "vat", "vatEnabled", "assortment", "pack", "stock"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/purchaseorder" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
