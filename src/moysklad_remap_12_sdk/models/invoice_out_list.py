...
class InvoiceOutList(BaseModel):
    """
    Список Счетов покупателям
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[InvoiceOut]] = Field(default=None, description="Массив Счетов покупателям")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [InvoiceOut.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
