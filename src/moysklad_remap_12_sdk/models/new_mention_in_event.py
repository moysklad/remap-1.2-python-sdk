...
class NewMentionInEvent(NotificationAbstract):
    """
    Уведомление о новом упоминании в ленте событий
    """ # noqa: E501
    operation: Optional[NotificationNamedEntity] = Field(default=None, description="Объект, в ленте которого добавлено событие с упоминанием")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "operation": NotificationNamedEntity.from_dict(obj["operation"]) if obj.get("operation") is not None else None
        })
