...
class RetailShiftPaymentOperation(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if isinstance(obj, dict):
            ...
            model_info = {
                "cashin": ("retail_shift_payment_operation_cash_in", "RetailShiftPaymentOperationCashIn"),
"paymentin": ("retail_shift_payment_operation_payment_in", "RetailShiftPaymentOperationPaymentIn")
            }.get(discriminator)
            if model_info:
