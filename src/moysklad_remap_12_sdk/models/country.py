...
class Country(EntityWithMeta):
    """
    Страна
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID страны")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    name: Optional[StrictStr] = Field(default=None, description="Наименование страны")
    description: Optional[StrictStr] = Field(default=None, description="Описание страны")
    code: Optional[StrictStr] = Field(default=None, description="Код страны")
    external_code: Optional[StrictStr] = Field(default=None, description="Внешний код страны", alias="externalCode")
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "name", "description", "code", "externalCode", "updated", "group", "owner", "shared"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/country" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
...
Country.model_rebuild(raise_errors=False)
