...
class ProductList(BaseModel):
    ...
    rows: Optional[List[Product]] = Field(default=None, description="Массив товаров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Product.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
