...
class SalePlatform(BaseModel):
    """
    Площадка для продаж
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID Площадки для продаж")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Площадки для продаж")
    sale_platform_group: Optional[StrictStr] = Field(default=None, description="Группа площадок для продаж. Известные значения описаны в SalePlatformGroup", alias="salePlatformGroup")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "name", "salePlatformGroup"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/saleplatform" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "salePlatformGroup": obj.get("salePlatformGroup")
        })
