...
class ReportMoneyPlotSeriesItem(BaseModel):
    """
    Показатель движения денежных средств за период отчета
    """ # noqa: E501
    var_date: Optional[StrictStr] = Field(default=None, description="Дата показателя в формате YYYY-MM-DD HH:MM:SS", alias="date")
    credit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Доход за период")
    debit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Расход за период")
    balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Баланс (доход минус расход)")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "credit", "debit", "balance"]
