...
class ByOperationsReserveList(BaseModel):
    """
    Отчет по документам номенклатуры, отображающий резервы
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ByOperationsReserve]] = Field(default=None, description="Массив строк отчета с резервами")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ByOperationsReserve.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
