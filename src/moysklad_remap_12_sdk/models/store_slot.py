...
class StoreSlot(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID Ячейки склада")
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Ячейки склада")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Ячейки склада", alias="externalCode")
    barcode: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Штрихкод ячейки")
    zone: Optional[StoreZone] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "updated", "name", "externalCode", "barcode", "zone"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/store" + "/" + parentId + "/slots" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "zone": StoreZone.from_dict(obj["zone"]) if obj.get("zone") is not None else None
        })
