...
class PayrollPosition(EntityWithMeta):
    """
    ...
    base_salary: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Начисления по окладу сотрудника", alias="baseSalary")
    piecework_salary: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Начисления сдельной оплаты сотрудника", alias="pieceworkSalary")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "employee", "baseSalary", "pieceworkSalary"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/payroll" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "pieceworkSalary": obj.get("pieceworkSalary")
        })
