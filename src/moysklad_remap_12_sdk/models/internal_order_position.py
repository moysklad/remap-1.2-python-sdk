...
class InternalOrderPosition(EntityWithMeta):
    """
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "quantity", "price", "vat", "vatEnabled", "assortment", "pack"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/internalorder" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
