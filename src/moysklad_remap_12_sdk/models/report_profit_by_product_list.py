...
class ReportProfitByProductList(BaseModel):
    """
    Отчет «Прибыльность по товарам»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportProfitByProduct]] = Field(default=None, description="Массив строк отчета прибыльности по товарам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportProfitByProduct.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
