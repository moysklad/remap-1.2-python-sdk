...
class StockByOperation(BaseModel):
    """
    ...
    positions: Optional[List[StockByOperationPosition]] = Field(default=None, description="Массив остатков по каждой из позиций документа")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "positions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "positions": [StockByOperationPosition.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
