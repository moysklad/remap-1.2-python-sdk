...
class ProcessingMaterialList(BaseModel):
    """
    Список материалов техоперации
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingMaterial]] = Field(default=None, description="Массив материалов техоперации")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingMaterial.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
