...
class ProcessingPlanMetadata(BaseModel):
    """
    Метаданные Техкарты
    """ # noqa: E501
    meta: Optional[Meta] = None
    attributes: Optional[AttributeMetaInfoList] = None
    create_shared: Optional[StrictBool] = Field(default=None, description="Создавать новые Техкарты с меткой \"Общий\"", alias="createShared")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "attributes", "createShared"]
