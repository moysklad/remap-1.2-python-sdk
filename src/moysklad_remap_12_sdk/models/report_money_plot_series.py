...
class ReportMoneyPlotSeries(BaseModel):
    """
    Отчет о движении денежных средств
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[Meta] = None
    credit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Доход за весь период отчета")
    debit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Расход за весь период отчета")
    series: Optional[List[ReportMoneyPlotSeriesItem]] = Field(default=None, description="Массив показателей движения денежных средств")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["context", "meta", "credit", "debit", "series"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "debit": obj.get("debit"),
            "series": [ReportMoneyPlotSeriesItem.from_dict(_item) for _item in obj["series"]] if obj.get("series") is not None else None
        })
