...
class DiscountList(BaseModel):
    ...
    rows: Optional[List[DiscountAbstract]] = Field(default=None, description="Массив скидок всех типов для учётной записи (см. `meta.type`: discount, personaldiscount, specialpricediscount, accumulationdiscount, bonusprogram). ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [DiscountAbstract.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
