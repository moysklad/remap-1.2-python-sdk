...
class NewMentionInTaskNote(NotificationAbstract):
    """
    Уведомление о новом упоминании в комментарии задачи
    """ # noqa: E501
    task: Optional[NotificationNamedEntity] = Field(default=None, description="Задача с комментарием, содержащим упоминание")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "task": NotificationNamedEntity.from_dict(obj["task"]) if obj.get("task") is not None else None
        })
