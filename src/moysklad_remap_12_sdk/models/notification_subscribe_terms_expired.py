...
class NotificationSubscribeTermsExpired(NotificationAbstract):
    """
    Уведомление об истечении условий подписки
    """ # noqa: E501
    days_left: Optional[StrictInt] = Field(default=None, description="Количество оставшихся дней подписки", alias="daysLeft")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["daysLeft"]
