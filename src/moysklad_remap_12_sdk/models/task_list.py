...
class TaskList(BaseModel):
    ...
    rows: Optional[List[Task]] = Field(default=None, description="Массив Задач")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Task.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
