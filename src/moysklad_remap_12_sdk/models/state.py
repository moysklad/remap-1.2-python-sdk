...
class State(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID статуса")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование статуса")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    color: Optional[StrictInt] = Field(default=None, description="Цвет Статуса")
    entity_type: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Тип сущности, к которой относится Статус (ключевое слово в рамках JSON API)", alias="entityType")
    state_type: Optional[StrictStr] = Field(default=None, description="Тип Статуса. Известные значения описаны в StateType", alias="stateType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "name", "accountId", "color", "entityType", "stateType"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/" + entityType + "/metadata" + "/states" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
