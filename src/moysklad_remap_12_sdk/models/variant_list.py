...
class VariantList(BaseModel):
    ...
    rows: Optional[List[Variant]] = Field(default=None, description="Массив Модификаций")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Variant.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
