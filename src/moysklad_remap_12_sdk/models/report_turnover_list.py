...
class ReportTurnoverList(BaseModel):
    """
    Отчет «Обороты по товарам»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportTurnover]] = Field(default=None, description="Массив строк отчета оборотов по товарам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportTurnover.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
