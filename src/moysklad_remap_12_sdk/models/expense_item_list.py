...
class ExpenseItemList(BaseModel):
    """
    Список статей расходов
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ExpenseItem]] = Field(default=None, description="Массив статей расходов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ExpenseItem.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
