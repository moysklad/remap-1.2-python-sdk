...
class Region(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID Региона")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Региона")
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код Региона")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Региона", alias="externalCode")
    updated: Optional[StrictStr] = Field(default=None, description="Время последнего изменения")
    version: Optional[StrictInt] = Field(default=None, description="Версия сущности")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "name", "code", "externalCode", "updated", "version"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/region" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
