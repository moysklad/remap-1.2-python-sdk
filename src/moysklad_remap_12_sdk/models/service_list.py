...
class ServiceList(BaseModel):
    ...
    rows: Optional[List[Service]] = Field(default=None, description="Массив услуг")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Service.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
