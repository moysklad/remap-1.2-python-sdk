...
class ProcessingList(BaseModel):
    ...
    rows: Optional[List[Processing]] = Field(default=None, description="Массив техопераций")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Processing.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
