...
class LossList(BaseModel):
    """
    Список Списаний
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[Loss]] = Field(default=None, description="Массив Списаний")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Loss.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
