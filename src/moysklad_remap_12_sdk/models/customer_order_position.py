...
class CustomerOrderPosition(EntityWithMeta):
    """
    ...
    reserve: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Резерв данной позиции")
    shipped: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Доставлено")
    ...
    assortment: Optional[ProductMarker] = Field(default=None, description="Метаданные товара/услуги/модификации/комплекта, которую представляет собой позиция")
    pack: Optional[Pack] = Field(default=None, description="Упаковка Товара")
    stock: Optional[PositionStock] = Field(default=None, description="Остатки и себестоимость позиции. Не выводится по умолчанию. Для получения передайте параметр `?fields=stock`. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "quantity", "price", "discount", "reserve", "shipped", "vat", "vatEnabled", "taxSystem", "assortment", "pack", "stock"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/customerorder" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "stock": PositionStock.from_dict(obj["stock"]) if obj.get("stock") is not None else None
        })
