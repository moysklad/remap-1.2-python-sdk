...
class Discount(DiscountAbstract):
    ...
    product_folders: Optional[List[ProductFolder]] = Field(default=None, description="Массив метаданных Групп товаров", alias="productFolders")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "meta", "productFolders"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/discount" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
