...
class LossPositionList(BaseModel):
    """
    Список позиций Списания
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = Field(default=None, description="Метаданные о выдаче")
    rows: Optional[List[LossPosition]] = Field(default=None, description="Массив позиций Списания")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [LossPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
