...
class StockByOperationList(BaseModel):
    """
    Отчет «Остатки по документам»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[StockByOperation]] = Field(default=None, description="Массив строк отчета с остатками по документам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [StockByOperation.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
