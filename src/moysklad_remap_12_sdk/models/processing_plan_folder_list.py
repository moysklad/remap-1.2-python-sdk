...
class ProcessingPlanFolderList(BaseModel):
    """
    Список групп техкарт
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingPlanFolder]] = Field(default=None, description="Массив групп техкарт")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingPlanFolder.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
