...
class AttributeCounterpartyEntity(AttributeAbstract):
    """
    AttributeCounterpartyEntity
    """ # noqa: E501
    type: Optional[StrictStr] = None
    value: Optional[Agent] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['counterparty']):
            raise ValueError("must be one of enum values ('counterparty')")
        return value
