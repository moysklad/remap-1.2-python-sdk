...
class EmbeddedTemplateList(BaseModel):
    """
    Список стандартных шаблонов печатных форм
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[EmbeddedTemplate]] = Field(default=None, description="Массив стандартных шаблонов печатных форм")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [EmbeddedTemplate.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
