...
class Thing(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID Серийного номера")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Значение серийного номера")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Комментарий к серийному номеру")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "name", "description"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/thing" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
