...
class NotificationOrderOverdue(NotificationAbstract):
    """
    ...
    order: Optional[NotificationOrder] = None
    sum: Optional[StrictInt] = Field(default=None, description="Сумма заказа")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["agentName", "deliveryPlannedMoment", "order", "sum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "order": NotificationOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
            "sum": obj.get("sum")
        })
