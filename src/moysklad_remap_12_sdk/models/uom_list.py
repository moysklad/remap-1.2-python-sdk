...
class UomList(BaseModel):
    ...
    rows: Optional[List[Uom]] = Field(default=None, description="Массив единиц измерения")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Uom.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
