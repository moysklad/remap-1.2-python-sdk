...
class AttributeEmployeeEntity(AttributeAbstract):
    """
    AttributeEmployeeEntity
    """ # noqa: E501
    type: Optional[StrictStr] = None
    value: Optional[Employee] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['employee']):
            raise ValueError("must be one of enum values ('employee')")
        return value
