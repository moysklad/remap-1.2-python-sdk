...
class NotificationInvoice(BaseModel):
    ...
    customer_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Имя покупателя", alias="customerName")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "name", "paymentPlannedMoment", "sum", "customerName"]
