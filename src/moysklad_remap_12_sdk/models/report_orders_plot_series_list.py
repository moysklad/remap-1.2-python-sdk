...
class ReportOrdersPlotSeriesList(BaseModel):
    """
    Показатели заказов покупателей
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[Meta] = None
    series: Optional[List[ReportPlotSeries]] = Field(default=None, description="Массив показателей заказов")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["context", "meta", "series"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "series": [ReportPlotSeries.from_dict(_item) for _item in obj["series"]] if obj.get("series") is not None else None
        })
