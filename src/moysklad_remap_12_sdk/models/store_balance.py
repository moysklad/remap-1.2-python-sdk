...
class StoreBalance(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID позиции неснижаемого остатка")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    meta: Optional[Meta] = None
    store: Optional[Store] = None
    quantity: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Количество неснижаемого остатка для склада")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "accountId", "meta", "store", "quantity"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/product" + "/" + parentId + "/storebalances" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
