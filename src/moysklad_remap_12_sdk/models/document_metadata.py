...
class DocumentMetadata(BaseModel):
    ...
    create_shared: Optional[StrictBool] = Field(default=None, description="Создавать новые документы с общим доступом", alias="createShared")
    states: Optional[List[State]] = Field(default=None, description="Массив статусов документа")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "attributes", "createShared", "states"]
