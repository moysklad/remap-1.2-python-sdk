...
class NotificationDiffValue(BaseModel):
    """
    Изменение поля связанного с уведомлением объекта
    """ # noqa: E501
    old_value: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Значение поля до изменения", alias="oldValue")
    new_value: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Значение поля после изменения", alias="newValue")
