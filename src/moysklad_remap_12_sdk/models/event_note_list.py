...
class EventNoteList(BaseModel):
    """
    Список Событий документа
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[EventNote]] = Field(default=None, description="Массив Событий документа")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [EventNote.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
