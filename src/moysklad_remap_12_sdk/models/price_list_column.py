...
class PriceListColumn(BaseModel):
    """
    Столбец Прайс-листа
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование столбца. Не может быть пустым и должно быть уникальным в пределах Прайс-листа")
    percentage_discount: Optional[StrictInt] = Field(default=None, description="Процентная наценка или скидка по умолчанию для столбца", alias="percentageDiscount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "percentageDiscount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            "name": obj.get("name"),
            "percentageDiscount": obj.get("percentageDiscount")
        })
