...
class CommissionReportOutList(BaseModel):
    """
    Список Выданных отчетов комиссионера
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[CommissionReportOut]] = Field(default=None, description="Массив Выданных отчетов комиссионера")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CommissionReportOut.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
