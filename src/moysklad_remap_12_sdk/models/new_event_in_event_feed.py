...
class NewEventInEventFeed(NotificationAbstract):
    """
    Уведомление о новом событии в отслеживаемом объекте
    """ # noqa: E501
    entity: Optional[NotificationNamedEntity] = Field(default=None, description="Объект, в ленте которого добавлено событие")
