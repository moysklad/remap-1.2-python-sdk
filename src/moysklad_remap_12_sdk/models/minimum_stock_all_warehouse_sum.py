...
class MinimumStockAllWarehouseSum(MinimumStockAbstract):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ALL_WAREHOUSE_SUM']):
            raise ValueError("must be one of enum values ('ALL_WAREHOUSE_SUM')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "type": obj.get("type") if obj.get("type") is not None else 'ALL_WAREHOUSE_SUM',
