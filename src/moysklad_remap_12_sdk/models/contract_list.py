...
class ContractList(BaseModel):
    ...
    rows: Optional[List[Contract]] = Field(default=None, description="Массив договоров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Contract.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
