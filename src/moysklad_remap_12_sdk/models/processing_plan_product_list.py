...
class ProcessingPlanProductList(BaseModel):
    """
    Список продуктов Техкарты
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingPlanProduct]] = Field(default=None, description="Массив продуктов Техкарты")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingPlanProduct.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
