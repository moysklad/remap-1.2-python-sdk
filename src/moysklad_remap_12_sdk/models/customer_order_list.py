...
class CustomerOrderList(BaseModel):
    ...
    rows: Optional[List[CustomerOrder]] = Field(default=None, description="Массив Заказов покупателей")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CustomerOrder.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
