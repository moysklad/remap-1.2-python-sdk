...
class PriceListList(BaseModel):
    ...
    rows: Optional[List[PriceList]] = Field(default=None, description="Массив Прайс-листов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [PriceList.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
