...
class PrepaymentReturnList(BaseModel):
    """
    Список Возвратов предоплаты
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[PrepaymentReturn]] = Field(default=None, description="Массив Возвратов предоплаты")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [PrepaymentReturn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
