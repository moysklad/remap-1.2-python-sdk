...
class CreateCommissionReportInPositions200ResponseInner(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateCommissionReportInPositions200ResponseInner.model_construct()
        error_messages = []
        match = 0
        # validate data type: CommissionReportInPosition
        if not isinstance(v, CommissionReportInPosition):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into CommissionReportInPosition
        try:
            instance.actual_instance = CommissionReportInPosition.from_json(json_str)
            match += 1
