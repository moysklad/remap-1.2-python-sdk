...
class WebhookStockList(BaseModel):
    """
    Список вебхуков на изменение остатков
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[WebhookStock]] = Field(default=None, description="Массив вебхуков на изменение остатков")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [WebhookStock.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
