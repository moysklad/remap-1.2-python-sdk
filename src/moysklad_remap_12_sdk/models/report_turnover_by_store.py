...
class ReportTurnoverByStore(BaseModel):
    """
    Строка отчета «Обороты по товару с детализацией по складам»
    """ # noqa: E501
    assortment: Optional[ReportTurnoverAssortment] = None
    stock_by_store: Optional[List[ReportTurnoverByStoreItem]] = Field(default=None, description="Детализация оборотов по складам", alias="stockByStore")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["assortment", "stockByStore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "stockByStore": [ReportTurnoverByStoreItem.from_dict(_item) for _item in obj["stockByStore"]] if obj.get("stockByStore") is not None else None
        })
