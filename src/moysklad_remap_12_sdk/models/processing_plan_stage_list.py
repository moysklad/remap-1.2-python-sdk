...
class ProcessingPlanStageList(BaseModel):
    """
    Список этапов Техкарты
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingPlanStage]] = Field(default=None, description="Массив этапов Техкарты")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingPlanStage.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
