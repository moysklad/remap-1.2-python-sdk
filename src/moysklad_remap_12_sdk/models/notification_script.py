...
class NotificationScript(NotificationAbstract):
    """
    Уведомление из сценария
    """ # noqa: E501
    event_type: Optional[StrictStr] = Field(default=None, description="Тип события сценария. Известные значения описаны в NotificationEventType", alias="eventType")
    entity: Optional[NotificationNamedEntity] = Field(default=None, description="Объект, на который сработал сценарий")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["eventType", "entity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "entity": NotificationNamedEntity.from_dict(obj["entity"]) if obj.get("entity") is not None else None
        })
