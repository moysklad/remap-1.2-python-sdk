...
class CashierList(BaseModel):
    ...
    rows: Optional[List[Cashier]] = Field(default=None, description="Массив кассиров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Cashier.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
...
CashierList.model_rebuild(raise_errors=False)
