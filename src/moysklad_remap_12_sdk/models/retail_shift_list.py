...
class RetailShiftList(BaseModel):
    """
    Список Розничных смен
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[RetailShift]] = Field(default=None, description="Массив Розничных смен")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [RetailShift.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
