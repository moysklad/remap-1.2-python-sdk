...
class ProcessingProcessPositionList(BaseModel):
    """
    Список позиций Техпроцесса
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ProcessingProcessPosition]] = Field(default=None, description="Массив позиций Техпроцесса")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ProcessingProcessPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
