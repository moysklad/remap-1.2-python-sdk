...
class WebhookStockNotificationPayload(BaseModel):
    """
    ...
    report_type: Optional[StrictStr] = Field(default=None, description="Тип отчёта. Известные значения описаны в WebhookStockReportType", alias="reportType")
    report_url: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="URL для получения данных по изменившейся номенклатуре за период (отчёт об остатках)", alias="reportUrl")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountId", "stockType", "reportType", "reportUrl"]
