...
class CashInList(BaseModel):
    """
    Список Приходных ордеров
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[CashIn]] = Field(default=None, description="Массив Приходных ордеров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CashIn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
