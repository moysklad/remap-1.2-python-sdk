...
class GetProductImages200Response(BaseModel):
    """
    GetProductImages200Response
    """ # noqa: E501
    meta: Optional[MetaList] = None
    rows: Optional[List[Image]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Image.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
