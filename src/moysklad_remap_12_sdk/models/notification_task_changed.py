...
class NotificationTaskChanged(NotificationAbstract):
    """
    Уведомление об изменении задачи
    """ # noqa: E501
    diff: Optional[NotificationTaskDiff] = None
    ...
    __properties: ClassVar[List[str]] = ["diff", "performedBy", "task"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "diff": NotificationTaskDiff.from_dict(obj["diff"]) if obj.get("diff") is not None else None,
