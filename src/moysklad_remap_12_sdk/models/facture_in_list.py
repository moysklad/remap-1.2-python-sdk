...
class FactureInList(BaseModel):
    """
    Список Счетов-фактур полученных
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[FactureIn]] = Field(default=None, description="Массив Счетов-фактур полученных")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [FactureIn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
