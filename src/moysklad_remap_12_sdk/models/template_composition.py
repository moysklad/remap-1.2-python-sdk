...
class TemplateComposition(BaseModel):
    """
    TemplateComposition
    """ # noqa: E501
    template: EmbeddedTemplate
    count: Annotated[int, Field(le=10, strict=True, ge=1)] = Field(description="Количество копий печатной формы")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["template", "count"]
