...
class EmbeddedTemplate(BaseModel):
    """
    Шаблон печатной формы
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID шаблона печатной формы")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование шаблона")
    type: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Тип шаблона")
    content: Optional[StrictStr] = Field(default=None, description="Ссылка на скачивание шаблона")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "name", "type", "content"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/" + type + "/metadata" + "/embeddedtemplate" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
