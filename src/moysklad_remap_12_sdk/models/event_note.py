...
class EventNote(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID События")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    created: Optional[StrictStr] = Field(default=None, description="Момент создания События")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Текст События")
    author: Optional[Employee] = None
    author_application: Optional[Application] = Field(default=None, description="Метаданные Решения - создателя События", alias="authorApplication")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "created", "description", "author", "authorApplication"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/" + documentType + "/" + parentId + "/notes" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
