...
class BundleComponentList(BaseModel):
    """
    Список элементов комплекта
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[BundleComponent]] = Field(default=None, description="Массив элементов комплекта")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [BundleComponent.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
