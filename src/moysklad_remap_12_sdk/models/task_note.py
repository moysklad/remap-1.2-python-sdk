...
class TaskNote(EntityWithMeta):
    """
    Комментарий к Задаче
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID комментария к Задаче")
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/task" + "/" + parentId + "/notes" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
