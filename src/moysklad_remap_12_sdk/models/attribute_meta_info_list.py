...
class AttributeMetaInfoList(BaseModel):
    """
    Доп.поля
    """ # noqa: E501
    meta: Optional[MetaList] = None
    rows: Optional[List[AttributeMetaInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [AttributeMetaInfo.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
