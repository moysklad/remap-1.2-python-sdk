...
class Application(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID решения")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи")
    name: Optional[StrictStr] = Field(default=None, description="Наименование решения")
    app_uid: Optional[StrictStr] = Field(default=None, description="Логин решения", alias="appUid")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "account_id", "name", "appUid"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/application" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
