...
class RetailShiftOperation(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if isinstance(obj, dict):
            ...
            model_info = {
                "retaildemand": ("retail_shift_operation_retail_demand", "RetailShiftOperationRetailDemand"),
"retailsalesreturn": ("retail_shift_operation_retail_sales_return", "RetailShiftOperationRetailSalesReturn"),
"retaildrawercashin": ("retail_shift_operation_retail_drawer_cash_in", "RetailShiftOperationRetailDrawerCashIn"),
"retaildrawercashout": ("retail_shift_operation_retail_drawer_cash_out", "RetailShiftOperationRetailDrawerCashOut"),
"prepayment": ("retail_shift_operation_prepayment", "RetailShiftOperationPrepayment"),
"prepaymentreturn": ("retail_shift_operation_prepayment_return", "RetailShiftOperationPrepaymentReturn")
            }.get(discriminator)
            if model_info:
