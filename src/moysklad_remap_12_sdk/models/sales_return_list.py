...
class SalesReturnList(BaseModel):
    ...
    rows: Optional[List[SalesReturn]] = Field(default=None, description="Массив Возвратов покупателей")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [SalesReturn.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
