...
class SalesChannelList(BaseModel):
    """
    Список Каналов продаж
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[SalesChannel]] = Field(default=None, description="Массив Каналов продаж")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [SalesChannel.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
