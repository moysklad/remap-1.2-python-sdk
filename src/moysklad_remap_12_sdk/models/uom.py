...
class Uom(EntityWithMeta):
    """
    Единица измерения
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID единицы измерения")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование единицы измерения")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Описание единицы измерения")
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код единицы измерения")
    ...
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код единицы измерения", alias="externalCode")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "name", "description", "code", "group", "owner", "updated", "shared", "externalCode"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/uom" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
