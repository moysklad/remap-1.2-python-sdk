...
class EnterPosition(EntityWithMeta):
    """
    ...
    reason: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Причина оприходования данной позиции")
    ...
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "assortment", "country", "gtd", "overhead", "pack", "price", "quantity", "reason", "slot", "things"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/enter" + "/" + parentId + "/positions" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
