...
class PriceListPositionList(BaseModel):
    """
    Список позиций Прайс-листа
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[PriceListPosition]] = Field(default=None, description="Массив позиций Прайс-листа")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [PriceListPosition.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
