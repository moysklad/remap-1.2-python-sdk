...
class EmissionOrderDocumentState(str, Enum):
    """
    ...
    """
    CREATED = 'CREATED'
    SUZ_CREATED = 'SUZ_CREATED'
    SUZ_SEND = 'SUZ_SEND'
    SUZ_COMPLETED = 'SUZ_COMPLETED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EmissionOrderDocumentState from a JSON string"""
