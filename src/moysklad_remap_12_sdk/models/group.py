...
class Group(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID группы")
    account_id: Optional[StrictStr] = Field(default=None, description="ID учетной записи", alias="accountId")
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование группы")
    index: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Порядковый номер в списке групп")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "name", "index"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/group" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
