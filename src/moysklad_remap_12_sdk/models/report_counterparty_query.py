...
class ReportCounterpartyQuery(BaseModel):
    """
    Запрос выборочных показателей контрагентов
    """ # noqa: E501
    counterparties: Annotated[List[ReportCounterpartyQueryCounterpartiesInner], Field(min_length=1)] = Field(description="Массив контрагентов, по которым требуются отчеты")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.counterparties:
            for _item_counterparties in self.counterparties:
                if _item_counterparties:
                    _items.append(_item_counterparties.to_dict())
            _dict['counterparties'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "counterparties": [ReportCounterpartyQueryCounterpartiesInner.from_dict(_item) for _item in obj["counterparties"]] if obj.get("counterparties") is not None else None
        })
