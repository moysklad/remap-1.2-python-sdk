...
class SalePrice(BaseModel):
    ...
    Цена продажи
    """ # noqa: E501
    value: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Значение цены")
    currency: Optional[Currency] = None
    price_type: PriceType = Field(alias="priceType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["value", "currency", "priceType"]
