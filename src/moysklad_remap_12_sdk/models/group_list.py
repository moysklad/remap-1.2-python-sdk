...
class GroupList(BaseModel):
    ...
    rows: Optional[List[Group]] = Field(default=None, description="Массив групп")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Group.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
