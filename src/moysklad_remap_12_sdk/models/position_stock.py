...
class PositionStock(BaseModel):
    ...
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Остаток")
    reserve: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Резерв")
    intransit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Ожидание")
    available: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Доступно")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["cost", "quantity", "reserve", "intransit", "available"]
