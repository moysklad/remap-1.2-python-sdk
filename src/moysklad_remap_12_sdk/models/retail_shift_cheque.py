...
class RetailShiftCheque(BaseModel):
    """
    Информация о смене ККТ
    """ # noqa: E501
    start: Optional[RetailShiftChequeStart] = None
    end: Optional[RetailShiftChequeEnd] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "start": RetailShiftChequeStart.from_dict(obj["start"]) if obj.get("start") is not None else None,
            "end": RetailShiftChequeEnd.from_dict(obj["end"]) if obj.get("end") is not None else None
        })
