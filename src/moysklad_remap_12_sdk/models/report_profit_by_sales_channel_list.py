...
class ReportProfitBySalesChannelList(BaseModel):
    """
    Отчет «Прибыльность по каналам продаж»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ReportProfitBySalesChannel]] = Field(default=None, description="Массив строк отчета прибыльности по каналам продаж")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ReportProfitBySalesChannel.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
