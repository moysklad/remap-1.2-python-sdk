...
class Inventory(EntityWithMeta):
    """
    Инвентаризация
    """ # noqa: E501
    meta: Optional[Meta] = None
    id: Optional[StrictStr] = Field(default=None, description="ID Инвентаризации")
    ...
    code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Код Инвентаризации")
    created: Optional[StrictStr] = Field(default=None, description="Дата создания")
    deleted: Optional[StrictStr] = Field(default=None, description="Момент последнего удаления Инвентаризации")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Комментарий Инвентаризации")
    external_code: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Внешний код Инвентаризации", alias="externalCode")
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Наименование Инвентаризации")
    organization: Optional[Organization] = None
    owner: Optional[Employee] = Field(default=None, description="Владелец (Сотрудник)")
    positions: Optional[InventoryPositionList] = Field(default=None, description="Метаданные позиций Инвентаризации")
    ...
    state: Optional[State] = Field(default=None, description="Метаданные статуса Инвентаризации")
    store: Optional[Store] = None
    sum: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Сумма Инвентаризации в копейках")
    sync_id: Optional[StrictStr] = Field(default=None, description="ID синхронизации", alias="syncId")
    updated: Optional[StrictStr] = Field(default=None, description="Момент последнего обновления Инвентаризации")
    enters: Optional[List[Enter]] = Field(default=None, description="Связанные с Инвентаризацией оприходования")
    losses: Optional[List[Loss]] = Field(default=None, description="Связанные с Инвентаризацией списания")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "id", "accountId", "attributes", "code", "created", "deleted", "description", "externalCode", "files", "group", "moment", "name", "organization", "owner", "positions", "printed", "published", "shared", "state", "store", "sum", "syncId", "updated", "enters", "losses"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/inventory" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _items = []
        if self.enters:
            for _item_enters in self.enters:
                if _item_enters:
                    _items.append(_item_enters.to_dict())
            _dict['enters'] = _items
        _items = []
        if self.losses:
        ...
        if self.enters is None and "enters" in self.model_fields_set:
            _dict['enters'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "positions": InventoryPositionList.from_dict(obj["positions"]) if obj.get("positions") is not None else None,
            ...
            "enters": [Enter.from_dict(_item) for _item in obj["enters"]] if obj.get("enters") is not None else None,
...
Inventory.model_rebuild(raise_errors=False)
