...
class AssortmentSettingsBarcodeRules(BaseModel):
    """
    Настройки правил штрихкодов для сущностей ассортимента
    """ # noqa: E501
    fill_ean13_barcode: Optional[StrictBool] = Field(default=None, description="Автоматически создавать штрихкод EAN13", alias="fillEAN13Barcode")
    weight_barcode: Optional[StrictBool] = Field(default=None, description="Использовать префиксы штрихкодов для весовых товаров", alias="weightBarcode")
    weight_barcode_prefix: Optional[StrictInt] = Field(default=None, description="Префикс штрихкодов для весовых товаров", alias="weightBarcodePrefix")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["fillEAN13Barcode", "weightBarcode", "weightBarcodePrefix"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = dict(obj)
        _data.update({
            "fillEAN13Barcode": obj.get("fillEAN13Barcode"),
            "weightBarcode": obj.get("weightBarcode"),
            "weightBarcodePrefix": obj.get("weightBarcodePrefix")
        })
