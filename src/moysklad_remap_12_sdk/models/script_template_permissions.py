...
class ScriptTemplatePermissions(BaseModel):
    """
    ...
    activate: Optional[StrictStr] = Field(default=None, description="Выполнять. Известные значения описаны в PermissionValue.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["view", "create", "update", "delete", "activate"]
