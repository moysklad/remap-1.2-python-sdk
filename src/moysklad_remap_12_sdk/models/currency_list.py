...
class CurrencyList(BaseModel):
    ...
    rows: Optional[List[Currency]] = Field(default=None, description="Массив валют")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [Currency.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
