...
class CreateSalesReturnPositions200ResponseInner(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateSalesReturnPositions200ResponseInner.model_construct()
        error_messages = []
        match = 0
        # validate data type: SalesReturnPosition
        if not isinstance(v, SalesReturnPosition):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into SalesReturnPosition
        try:
            instance.actual_instance = SalesReturnPosition.from_json(json_str)
            match += 1
