...
class AccumulationDiscount(DiscountAbstract):
    """
    ...
    levels: Optional[List[AccumulationDiscountLevelsInner]] = Field(default=None, description="Проценты скидок при определенной сумме продаж")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "meta", "productFolders", "levels"]
    ...
    def create_with_meta(
        ...
        href = Configuration.get_default().host + "/entity" + "/accumulationdiscount" + "/" + id
        return cls(
            id=id,
            meta=Meta(
                href=href,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "levels": [AccumulationDiscountLevelsInner.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None
        })
