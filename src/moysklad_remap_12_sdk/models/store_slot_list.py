...
class StoreSlotList(BaseModel):
    """
    Список ячеек Склада
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[StoreSlot]] = Field(default=None, description="Массив ячеек Склада")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [StoreSlot.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
...
StoreSlotList.model_rebuild(raise_errors=False)
