...
class StockByStoreList(BaseModel):
    """
    Отчет «Остатки по складам»
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[StockByStore]] = Field(default=None, description="Массив строк отчета. Набор типов строк зависит от параметра запроса `groupBy` (см. `meta.type`: product, variant, consignment). ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [StockByStore.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
