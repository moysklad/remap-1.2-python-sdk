...
class AttributeLong(AttributeAbstract):
    """
    AttributeLong
    """ # noqa: E501
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['long']):
            raise ValueError("must be one of enum values ('long')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeLong from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeLong from a dict"""
        if obj is None:
            return None
