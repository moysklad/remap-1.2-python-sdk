...
class CounterpartyAdjustmentList(BaseModel):
    """
    Список Корректировок взаиморасчетов
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[CounterpartyAdjustment]] = Field(default=None, description="Массив Корректировок взаиморасчетов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [CounterpartyAdjustment.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
