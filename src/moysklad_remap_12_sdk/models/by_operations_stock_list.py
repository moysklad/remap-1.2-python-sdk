...
class ByOperationsStockList(BaseModel):
    """
    Отчет по документам номенклатуры, отображающий остатки
    """ # noqa: E501
    context: Optional[Context] = None
    meta: Optional[MetaList] = None
    rows: Optional[List[ByOperationsStock]] = Field(default=None, description="Массив строк отчета с остатками")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "rows": [ByOperationsStock.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
