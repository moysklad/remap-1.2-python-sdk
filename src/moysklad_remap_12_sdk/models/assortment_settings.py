...
class AssortmentSettings(BaseModel):
    """
    Настройки ассортимента
    """ # noqa: E501
    meta: Optional[Meta] = None
    barcode_rules: Optional[AssortmentSettingsBarcodeRules] = Field(default=None, alias="barcodeRules")
    unique_code_rules: Optional[AssortmentSettingsUniqueCodeRules] = Field(default=None, alias="uniqueCodeRules")
    created_shared: Optional[StrictBool] = Field(default=None, description="Создавать новые элементы с меткой \"Общий\"", alias="createdShared")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["meta", "barcodeRules", "uniqueCodeRules", "createdShared"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.barcode_rules:
            _dict['barcodeRules'] = self.barcode_rules.to_dict()
        if self.unique_code_rules:
            _dict['uniqueCodeRules'] = self.unique_code_rules.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data.update({
            ...
            "barcodeRules": AssortmentSettingsBarcodeRules.from_dict(obj["barcodeRules"]) if obj.get("barcodeRules") is not None else None,
            "uniqueCodeRules": AssortmentSettingsUniqueCodeRules.from_dict(obj["uniqueCodeRules"]) if obj.get("uniqueCodeRules") is not None else None,
            "createdShared": obj.get("createdShared")
        })
